...
__INLINE void rpl_btrfip_ver_unpack(uint8_t* typ, uint8_t* rel, uint8_t* upg, uint8_t* build)
{
    ...
    localVal = REG_RPL_RD(RPL_BTRFIP_VER_ADDR);
...
#define RPL_RFDYNCNTL_RESET  0x10000000
...
// field definitions
#define RPL_RATE_MASK           ((uint32_t)0x30000000)
#define RPL_RATE_LSB            28
#define RPL_RATE_WIDTH          ((uint32_t)0x00000002)
#define RPL_FORCE_RATE_BIT      ((uint32_t)0x01000000)
#define RPL_FORCE_RATE_POS      24
...
#define RPL_RATE_RST            0x1
#define RPL_FORCE_RATE_RST      0x0
...
__INLINE void rpl_rfdyncntl_pack(uint8_t rate, uint8_t forcerate, uint8_t txedrgain, uint8_t txgfskgain, uint8_t channel, uint8_t btleen, uint8_t rxen, uint8_t txedr, uint8_t txen)
{
    ASSERT_ERR((((uint32_t)rate << 28) & ~((uint32_t)0x30000000)) == 0);
    ASSERT_ERR((((uint32_t)forcerate << 24) & ~((uint32_t)0x01000000)) == 0);
    ...
    REG_RPL_WR(RPL_RFDYNCNTL_ADDR,  ((uint32_t)rate << 28) | ((uint32_t)forcerate << 24) | ((uint32_t)txedrgain << 20) | ((uint32_t)txgfskgain << 16) | ((uint32_t)channel << 8) | ((uint32_t)btleen << 7) | ((uint32_t)rxen << 4) | ((uint32_t)txedr << 1) | ((uint32_t)txen << 0));
}

__INLINE void rpl_rfdyncntl_unpack(uint8_t* rate, uint8_t* forcerate, uint8_t* txedrgain, uint8_t* txgfskgain, uint8_t* channel, uint8_t* btleen, uint8_t* rxen, uint8_t* txedr, uint8_t* txen)
{
    uint32_t localVal;

    localVal = REG_RPL_RD(RPL_RFDYNCNTL_ADDR);
    *rate = (localVal & ((uint32_t)0x30000000)) >> 28;
    *forcerate = (localVal & ((uint32_t)0x01000000)) >> 24;
...
__INLINE uint8_t rpl_rate_getf(void)
{
    uint32_t localVal;
...
__INLINE void rpl_rate_setf(uint8_t rate)
{
    ASSERT_ERR((((uint32_t)rate << 28) & ~((uint32_t)0x30000000)) == 0);
    REG_RPL_WR(RPL_RFDYNCNTL_ADDR, (REG_RPL_RD(RPL_RFDYNCNTL_ADDR) & ~((uint32_t)0x30000000)) | ((uint32_t)rate << 28));
}

__INLINE uint8_t rpl_force_rate_getf(void)
{
    uint32_t localVal;
...
__INLINE void rpl_force_rate_setf(uint8_t forcerate)
{
    ASSERT_ERR((((uint32_t)forcerate << 24) & ~((uint32_t)0x01000000)) == 0);
    REG_RPL_WR(RPL_RFDYNCNTL_ADDR, (REG_RPL_RD(RPL_RFDYNCNTL_ADDR) & ~((uint32_t)0x01000000)) | ((uint32_t)forcerate << 24));
}
...
__INLINE void rpl_seqcntl_unpack(uint8_t* rxflagcheck, uint8_t* rxdivfactor, uint8_t* txflagcheck, uint8_t* txdivfactor)
{
    ...
    localVal = REG_RPL_RD(RPL_SEQCNTL_ADDR);
...
__INLINE void rpl_rftxup_dly0_unpack(uint16_t* txupdly2, uint16_t* txupdly1, uint16_t* txupdly0)
{
    ...
    localVal = REG_RPL_RD(RPL_RFTXUP_DLY0_ADDR);
...
__INLINE void rpl_rftxup_dly1_unpack(uint16_t* txupdly5, uint16_t* txupdly4, uint16_t* txupdly3)
{
    ...
    localVal = REG_RPL_RD(RPL_RFTXUP_DLY1_ADDR);
...
__INLINE void rpl_rftxup_dly2_unpack(uint16_t* txupdly8, uint16_t* txupdly7, uint16_t* txupdly6)
{
    ...
    localVal = REG_RPL_RD(RPL_RFTXUP_DLY2_ADDR);
...
__INLINE void rpl_rftxdn_dly0_unpack(uint16_t* txdndly2, uint16_t* txdndly1, uint16_t* txdndly0)
{
    ...
    localVal = REG_RPL_RD(RPL_RFTXDN_DLY0_ADDR);
...
__INLINE void rpl_rftxdn_dly1_unpack(uint16_t* txdndly5, uint16_t* txdndly4, uint16_t* txdndly3)
{
    ...
    localVal = REG_RPL_RD(RPL_RFTXDN_DLY1_ADDR);
...
__INLINE void rpl_rftxdn_dly2_unpack(uint16_t* txdndly8, uint16_t* txdndly7, uint16_t* txdndly6)
{
    ...
    localVal = REG_RPL_RD(RPL_RFTXDN_DLY2_ADDR);
...
__INLINE void rpl_rfrxup_dly0_unpack(uint16_t* rxupdly2, uint16_t* rxupdly1, uint16_t* rxupdly0)
{
    ...
    localVal = REG_RPL_RD(RPL_RFRXUP_DLY0_ADDR);
...
__INLINE void rpl_rfrxup_dly1_unpack(uint16_t* rxupdly5, uint16_t* rxupdly4, uint16_t* rxupdly3)
{
    ...
    localVal = REG_RPL_RD(RPL_RFRXUP_DLY1_ADDR);
...
__INLINE void rpl_rfrxup_dly2_unpack(uint16_t* rxupdly8, uint16_t* rxupdly7, uint16_t* rxupdly6)
{
    ...
    localVal = REG_RPL_RD(RPL_RFRXUP_DLY2_ADDR);
...
__INLINE void rpl_rfrxdn_dly0_unpack(uint16_t* rxdndly2, uint16_t* rxdndly1, uint16_t* rxdndly0)
{
    ...
    localVal = REG_RPL_RD(RPL_RFRXDN_DLY0_ADDR);
...
__INLINE void rpl_rfrxdn_dly1_unpack(uint16_t* rxdndly5, uint16_t* rxdndly4, uint16_t* rxdndly3)
{
    ...
    localVal = REG_RPL_RD(RPL_RFRXDN_DLY1_ADDR);
...
__INLINE void rpl_rfrxdn_dly2_unpack(uint16_t* rxdndly8, uint16_t* rxdndly7, uint16_t* rxdndly6)
{
    ...
    localVal = REG_RPL_RD(RPL_RFRXDN_DLY2_ADDR);
...
__INLINE void rpl_seqtxup_out0_unpack(uint16_t* txupout2, uint16_t* txupout1, uint16_t* txupout0)
{
    ...
    localVal = REG_RPL_RD(RPL_SEQTXUP_OUT0_ADDR);
...
__INLINE void rpl_seqtxup_out1_unpack(uint16_t* txupout5, uint16_t* txupout4, uint16_t* txupout3)
{
    ...
    localVal = REG_RPL_RD(RPL_SEQTXUP_OUT1_ADDR);
...
__INLINE void rpl_seqtxup_out2_unpack(uint16_t* txupout8, uint16_t* txupout7, uint16_t* txupout6)
{
    ...
    localVal = REG_RPL_RD(RPL_SEQTXUP_OUT2_ADDR);
...
__INLINE void rpl_seqtxdn_out0_unpack(uint16_t* txdnout2, uint16_t* txdnout1, uint16_t* txdnout0)
{
    ...
    localVal = REG_RPL_RD(RPL_SEQTXDN_OUT0_ADDR);
...
__INLINE void rpl_seqtxdn_out1_unpack(uint16_t* txdnout5, uint16_t* txdnout4, uint16_t* txdnout3)
{
    ...
    localVal = REG_RPL_RD(RPL_SEQTXDN_OUT1_ADDR);
...
__INLINE void rpl_seqtxdn_out2_unpack(uint16_t* txdnout8, uint16_t* txdnout7, uint16_t* txdnout6)
{
    ...
    localVal = REG_RPL_RD(RPL_SEQTXDN_OUT2_ADDR);
...
__INLINE void rpl_seqrxup_out0_unpack(uint16_t* rxupout2, uint16_t* rxupout1, uint16_t* rxupout0)
{
    ...
    localVal = REG_RPL_RD(RPL_SEQRXUP_OUT0_ADDR);
...
__INLINE void rpl_seqrxup_out1_unpack(uint16_t* rxupout5, uint16_t* rxupout4, uint16_t* rxupout3)
{
    ...
    localVal = REG_RPL_RD(RPL_SEQRXUP_OUT1_ADDR);
...
__INLINE void rpl_seqrxup_out2_unpack(uint16_t* rxupout8, uint16_t* rxupout7, uint16_t* rxupout6)
{
    ...
    localVal = REG_RPL_RD(RPL_SEQRXUP_OUT2_ADDR);
...
__INLINE void rpl_seqrxdn_out0_unpack(uint16_t* rxdnout2, uint16_t* rxdnout1, uint16_t* rxdnout0)
{
    ...
    localVal = REG_RPL_RD(RPL_SEQRXDN_OUT0_ADDR);
...
__INLINE void rpl_seqrxdn_out1_unpack(uint16_t* rxdnout5, uint16_t* rxdnout4, uint16_t* rxdnout3)
{
    ...
    localVal = REG_RPL_RD(RPL_SEQRXDN_OUT1_ADDR);
...
__INLINE void rpl_seqrxdn_out2_unpack(uint16_t* rxdnout8, uint16_t* rxdnout7, uint16_t* rxdnout6)
{
    ...
    localVal = REG_RPL_RD(RPL_SEQRXDN_OUT2_ADDR);
...
#define RPL_RFSWCNTL_RESET  0x00002000
...
// field definitions
#define RPL_ANA_EN_BIT          ((uint32_t)0x00002000)
#define RPL_ANA_EN_POS          13
...
#define RPL_ANA_EN_RST          0x1
#define RPL_TESTMUX_EN_RST      0x0
#define RPL_SEL_INPUTBUF_RST    0x0
#define RPL_SEL_RFSW32_RST      0x0
#define RPL_SEL_RFSW10_RST      0x0

__INLINE void rpl_rfswcntl_pack(uint8_t anaen, uint8_t testmuxen, uint8_t selinputbuf, uint8_t selrfsw32, uint8_t selrfsw10)
{
    ASSERT_ERR((((uint32_t)anaen << 13) & ~((uint32_t)0x00002000)) == 0);
    ...
    REG_RPL_WR(RPL_RFSWCNTL_ADDR,  ((uint32_t)anaen << 13) | ((uint32_t)testmuxen << 12) | ((uint32_t)selinputbuf << 8) | ((uint32_t)selrfsw32 << 4) | ((uint32_t)selrfsw10 << 0));
}

__INLINE void rpl_rfswcntl_unpack(uint8_t* anaen, uint8_t* testmuxen, uint8_t* selinputbuf, uint8_t* selrfsw32, uint8_t* selrfsw10)
{
    uint32_t localVal;

    localVal = REG_RPL_RD(RPL_RFSWCNTL_ADDR);
    *anaen = (localVal & ((uint32_t)0x00002000)) >> 13;
...
__INLINE uint8_t rpl_ana_en_getf(void)
{
    uint32_t localVal;
...
__INLINE void rpl_ana_en_setf(uint8_t anaen)
{
    ASSERT_ERR((((uint32_t)anaen << 13) & ~((uint32_t)0x00002000)) == 0);
    REG_RPL_WR(RPL_RFSWCNTL_ADDR, (REG_RPL_RD(RPL_RFSWCNTL_ADDR) & ~((uint32_t)0x00002000)) | ((uint32_t)anaen << 13));
}
 ...
 *  25:24       XO_BUFFER_TRIM   0x2
 *  21:20        XO_BIAS_TRIMH   0x3
 *  19:18           RPLL_DELTA   0x0
 *     14              XO32_ON   0
 *  13:12         XO_BIAS_TRIM   0x3
 *     11           XO_TEST_EN   0
...
#define RPL_RPLLCNTL0_RESET  0x02303000
...
#define RPL_XO_BUFFER_TRIM_MASK    ((uint32_t)0x03000000)
#define RPL_XO_BUFFER_TRIM_LSB     24
#define RPL_XO_BUFFER_TRIM_WIDTH   ((uint32_t)0x00000002)
#define RPL_XO_BIAS_TRIMH_MASK     ((uint32_t)0x00300000)
#define RPL_XO_BIAS_TRIMH_LSB      20
#define RPL_XO_BIAS_TRIMH_WIDTH    ((uint32_t)0x00000002)
...
__INLINE void rpl_rpllcntl0_pack(uint8_t forcerpllctrl, uint8_t xobuffertrim, uint8_t xobiastrimh, uint8_t rplldelta, uint8_t xo32on, uint8_t xobiastrim, uint8_t xotesten, uint8_t xoopendrainen, uint8_t xorefclken, uint8_t xoon, uint8_t rpllvcorefon, uint8_t rplllocnton, uint8_t rpllldon, uint8_t rpllvcoon, uint8_t rpllcpon, uint8_t rplldivon)
{
    ASSERT_ERR((((uint32_t)forcerpllctrl << 31) & ~((uint32_t)0x80000000)) == 0);
    ASSERT_ERR((((uint32_t)xobuffertrim << 24) & ~((uint32_t)0x03000000)) == 0);
    ASSERT_ERR((((uint32_t)xobiastrimh << 20) & ~((uint32_t)0x00300000)) == 0);
    ...
    REG_RPL_WR(RPL_RPLLCNTL0_ADDR,  ((uint32_t)forcerpllctrl << 31) | ((uint32_t)xobuffertrim << 24) | ((uint32_t)xobiastrimh << 20) | ((uint32_t)rplldelta << 18) | ((uint32_t)xo32on << 14) | ((uint32_t)xobiastrim << 12) | ((uint32_t)xotesten << 11) | ((uint32_t)xoopendrainen << 10) | ((uint32_t)xorefclken << 9) | ((uint32_t)xoon << 8) | ((uint32_t)rpllvcorefon << 5) | ((uint32_t)rplllocnton << 4) | ((uint32_t)rpllldon << 3) | ((uint32_t)rpllvcoon << 2) | ((uint32_t)rpllcpon << 1) | ((uint32_t)rplldivon << 0));
}

__INLINE void rpl_rpllcntl0_unpack(uint8_t* forcerpllctrl, uint8_t* xobuffertrim, uint8_t* xobiastrimh, uint8_t* rplldelta, uint8_t* xo32on, uint8_t* xobiastrim, uint8_t* xotesten, uint8_t* xoopendrainen, uint8_t* xorefclken, uint8_t* xoon, uint8_t* rpllvcorefon, uint8_t* rplllocnton, uint8_t* rpllldon, uint8_t* rpllvcoon, uint8_t* rpllcpon, uint8_t* rplldivon)
{
    uint32_t localVal;

    localVal = REG_RPL_RD(RPL_RPLLCNTL0_ADDR);
    *forcerpllctrl = (localVal & ((uint32_t)0x80000000)) >> 31;
    *xobuffertrim = (localVal & ((uint32_t)0x03000000)) >> 24;
    *xobiastrimh = (localVal & ((uint32_t)0x00300000)) >> 20;
...
__INLINE uint8_t rpl_xo_buffer_trim_getf(void)
{
    uint32_t localVal;
...
__INLINE void rpl_xo_buffer_trim_setf(uint8_t xobuffertrim)
{
    ASSERT_ERR((((uint32_t)xobuffertrim << 24) & ~((uint32_t)0x03000000)) == 0);
    REG_RPL_WR(RPL_RPLLCNTL0_ADDR, (REG_RPL_RD(RPL_RPLLCNTL0_ADDR) & ~((uint32_t)0x03000000)) | ((uint32_t)xobuffertrim << 24));
}

__INLINE uint8_t rpl_xo_bias_trimh_getf(void)
{
    uint32_t localVal;
...
__INLINE void rpl_xo_bias_trimh_setf(uint8_t xobiastrimh)
{
    ASSERT_ERR((((uint32_t)xobiastrimh << 20) & ~((uint32_t)0x00300000)) == 0);
    REG_RPL_WR(RPL_RPLLCNTL0_ADDR, (REG_RPL_RD(RPL_RPLLCNTL0_ADDR) & ~((uint32_t)0x00300000)) | ((uint32_t)xobiastrimh << 20));
}
 ...
 *   Bits           Field Name   Reset Value
 *  -----   ------------------   -----------
 *  30:28           RPLL_IVCOH   0x7
 *  26:24   RPLL_IVCO_BUF_TRIM   0x3
 *     22   RPLL_VCOREFBACKUP_EN   0
 *     21          RPLL_VCOFCH   0
 *     20            RPLL_NREF   0
 *  18:16         RPLL_CP_TEST   0x0
 *  14:12      RPLL_ICP_OFFSET   0x6
 *  11:08             RPLL_ICP   0x4
...
#define RPL_RPLLCNTL1_RESET  0x7300640C
...
// field definitions
#define RPL_RPLL_IVCOH_MASK             ((uint32_t)0x70000000)
#define RPL_RPLL_IVCOH_LSB              28
#define RPL_RPLL_IVCOH_WIDTH            ((uint32_t)0x00000003)
#define RPL_RPLL_IVCO_BUF_TRIM_MASK     ((uint32_t)0x07000000)
#define RPL_RPLL_IVCO_BUF_TRIM_LSB      24
#define RPL_RPLL_IVCO_BUF_TRIM_WIDTH    ((uint32_t)0x00000003)
#define RPL_RPLL_VCOREFBACKUP_EN_BIT    ((uint32_t)0x00400000)
#define RPL_RPLL_VCOREFBACKUP_EN_POS    22
#define RPL_RPLL_VCOFCH_BIT             ((uint32_t)0x00200000)
#define RPL_RPLL_VCOFCH_POS             21
...
#define RPL_RPLL_IVCOH_RST              0x7
#define RPL_RPLL_IVCO_BUF_TRIM_RST      0x3
#define RPL_RPLL_VCOREFBACKUP_EN_RST    0x0
#define RPL_RPLL_VCOFCH_RST             0x0
#define RPL_RPLL_NREF_RST               0x0
#define RPL_RPLL_CP_TEST_RST            0x0
#define RPL_RPLL_ICP_OFFSET_RST         0x6
#define RPL_RPLL_ICP_RST                0x4
#define RPL_RPLL_VCOFC_RST              0x0
#define RPL_RPLL_IVCO_RST               0x3
#define RPL_RPLL_VCO_MODE_RST           0x0

__INLINE void rpl_rpllcntl1_pack(uint8_t rpllivcoh, uint8_t rpllivcobuftrim, uint8_t rpllvcorefbackupen, uint8_t rpllvcofch, uint8_t rpllnref, uint8_t rpllcptest, uint8_t rpllicpoffset, uint8_t rpllicp, uint8_t rpllvcofc, uint8_t rpllivco, uint8_t rpllvcomode)
{
    ASSERT_ERR((((uint32_t)rpllivcoh << 28) & ~((uint32_t)0x70000000)) == 0);
    ASSERT_ERR((((uint32_t)rpllivcobuftrim << 24) & ~((uint32_t)0x07000000)) == 0);
    ASSERT_ERR((((uint32_t)rpllvcorefbackupen << 22) & ~((uint32_t)0x00400000)) == 0);
    ASSERT_ERR((((uint32_t)rpllvcofch << 21) & ~((uint32_t)0x00200000)) == 0);
    ...
    REG_RPL_WR(RPL_RPLLCNTL1_ADDR,  ((uint32_t)rpllivcoh << 28) | ((uint32_t)rpllivcobuftrim << 24) | ((uint32_t)rpllvcorefbackupen << 22) | ((uint32_t)rpllvcofch << 21) | ((uint32_t)rpllnref << 20) | ((uint32_t)rpllcptest << 16) | ((uint32_t)rpllicpoffset << 12) | ((uint32_t)rpllicp << 8) | ((uint32_t)rpllvcofc << 4) | ((uint32_t)rpllivco << 2) | ((uint32_t)rpllvcomode << 0));
}

__INLINE void rpl_rpllcntl1_unpack(uint8_t* rpllivcoh, uint8_t* rpllivcobuftrim, uint8_t* rpllvcorefbackupen, uint8_t* rpllvcofch, uint8_t* rpllnref, uint8_t* rpllcptest, uint8_t* rpllicpoffset, uint8_t* rpllicp, uint8_t* rpllvcofc, uint8_t* rpllivco, uint8_t* rpllvcomode)
{
    uint32_t localVal;

    localVal = REG_RPL_RD(RPL_RPLLCNTL1_ADDR);
    *rpllivcoh = (localVal & ((uint32_t)0x70000000)) >> 28;
    *rpllivcobuftrim = (localVal & ((uint32_t)0x07000000)) >> 24;
    *rpllvcorefbackupen = (localVal & ((uint32_t)0x00400000)) >> 22;
    *rpllvcofch = (localVal & ((uint32_t)0x00200000)) >> 21;
...
__INLINE uint8_t rpl_rpll_ivcoh_getf(void)
{
    uint32_t localVal;
...
__INLINE void rpl_rpll_ivcoh_setf(uint8_t rpllivcoh)
{
    ASSERT_ERR((((uint32_t)rpllivcoh << 28) & ~((uint32_t)0x70000000)) == 0);
    REG_RPL_WR(RPL_RPLLCNTL1_ADDR, (REG_RPL_RD(RPL_RPLLCNTL1_ADDR) & ~((uint32_t)0x70000000)) | ((uint32_t)rpllivcoh << 28));
}
...
{
    ASSERT_ERR((((uint32_t)rpllivcobuftrim << 24) & ~((uint32_t)0x07000000)) == 0);
    REG_RPL_WR(RPL_RPLLCNTL1_ADDR, (REG_RPL_RD(RPL_RPLLCNTL1_ADDR) & ~((uint32_t)0x07000000)) | ((uint32_t)rpllivcobuftrim << 24));
}
...
__INLINE uint8_t rpl_rpll_vcofch_getf(void)
{
    uint32_t localVal;
...
__INLINE void rpl_rpll_vcofch_setf(uint8_t rpllvcofch)
{
    ASSERT_ERR((((uint32_t)rpllvcofch << 21) & ~((uint32_t)0x00200000)) == 0);
    REG_RPL_WR(RPL_RPLLCNTL1_ADDR, (REG_RPL_RD(RPL_RPLLCNTL1_ADDR) & ~((uint32_t)0x00200000)) | ((uint32_t)rpllvcofch << 21));
}
...
#define RPL_RPLL_UNLOCK_CNT_MASK       ((uint32_t)0x0000FF00)
#define RPL_RPLL_UNLOCK_CNT_LSB        8
#define RPL_RPLL_UNLOCK_CNT_WIDTH      ((uint32_t)0x00000008)
...
__INLINE void rpl_rpllcntl2_pack(uint8_t rpllldfrefinven, uint8_t rpllldfdivinven, uint8_t rplledgescomp, uint8_t rpllfedetectval, uint8_t rpllredetectval, uint8_t rpllunlockcnt, uint8_t rplllockcnt)
{
    ...
    ASSERT_ERR((((uint32_t)rpllunlockcnt << 8) & ~((uint32_t)0x0000FF00)) == 0);
...
__INLINE void rpl_rpllcntl2_unpack(uint8_t* rpllldfrefinven, uint8_t* rpllldfdivinven, uint8_t* rplledgescomp, uint8_t* rpllfedetectval, uint8_t* rpllredetectval, uint8_t* rpllunlockcnt, uint8_t* rplllockcnt)
{
    ...
    localVal = REG_RPL_RD(RPL_RPLLCNTL2_ADDR);
    ...
    *rpllunlockcnt = (localVal & ((uint32_t)0x0000FF00)) >> 8;
...
{
    ASSERT_ERR((((uint32_t)rpllunlockcnt << 8) & ~((uint32_t)0x0000FF00)) == 0);
    REG_RPL_WR(RPL_RPLLCNTL2_ADDR, (REG_RPL_RD(RPL_RPLLCNTL2_ADDR) & ~((uint32_t)0x0000FF00)) | ((uint32_t)rpllunlockcnt << 8));
}
...
__INLINE void rpl_rfpllstat_unpack(uint16_t* rplllocntval, uint8_t* rplllocntdone, uint8_t* fifooverflow, uint8_t* rplllocked)
{
    ...
    localVal = REG_RPL_RD(RPL_RFPLLSTAT_ADDR);
...
__INLINE void rpl_rpllsdcntl0_unpack(uint32_t* rplln0fract, uint8_t* rplln0int)
{
    ...
    localVal = REG_RPL_RD(RPL_RPLLSDCNTL0_ADDR);
...
__INLINE uint32_t rpl_rpll_chfract_getf(void)
{
    ...
    localVal = REG_RPL_RD(RPL_RPLLSDCNTL1_ADDR);
...
__INLINE void rpl_rpllsdcntl2_unpack(uint8_t* btledumoen, uint8_t* btlefilterscaling, uint8_t* filterscaling, uint8_t* fmtx2pen, uint8_t* fmtxen, uint8_t* sdditheren, uint8_t* rpllsdorder, uint8_t* rpllfracen)
{
    ...
    localVal = REG_RPL_RD(RPL_RPLLSDCNTL2_ADDR);
...
__INLINE void rpl_rpllsdstat_unpack(uint32_t* rpllnfract, uint8_t* rpllnint)
{
    ...
    localVal = REG_RPL_RD(RPL_RPLLSDSTAT_ADDR);
...
__INLINE void rpl_rpllmash_init_unpack(uint8_t* mashsdi4, uint8_t* mashsdi3, uint8_t* mashsdi2, uint8_t* mashsdi1)
{
    ...
    localVal = REG_RPL_RD(RPL_RPLLMASH_INIT_ADDR);
...
__INLINE uint32_t rpl_filt_coeff_getf(int reg_idx)
{
    ...
    localVal = REG_RPL_RD(RPL_GFSK_FILT_COEFF_ADDR + reg_idx * 1);
 ...
 *  13:12    DPLL_IBVCO_BUFFER   0x3
 *  09:08        DPLL_KVCO_SEL   0x1
 *  06:04           DPLL_IBVCO   0x3
 *     03           DPLL_LD_ON   0
 *     02          DPLL_VCO_ON   1
 *     01           DPLL_CP_ON   0
 * </pre>
...
#define RPL_DPLLCNTL0_RESET  0x00003134
...
#define RPL_DPLL_IBVCO_BUFFER_MASK   ((uint32_t)0x00003000)
#define RPL_DPLL_IBVCO_BUFFER_LSB    12
#define RPL_DPLL_IBVCO_BUFFER_WIDTH  ((uint32_t)0x00000002)
#define RPL_DPLL_KVCO_SEL_MASK       ((uint32_t)0x00000300)
#define RPL_DPLL_KVCO_SEL_LSB        8
#define RPL_DPLL_KVCO_SEL_WIDTH      ((uint32_t)0x00000002)
#define RPL_DPLL_IBVCO_MASK          ((uint32_t)0x00000070)
#define RPL_DPLL_IBVCO_LSB           4
#define RPL_DPLL_IBVCO_WIDTH         ((uint32_t)0x00000003)
...
#define RPL_DPLL_IBVCO_BUFFER_RST    0x3
#define RPL_DPLL_KVCO_SEL_RST        0x1
#define RPL_DPLL_IBVCO_RST           0x3
#define RPL_DPLL_LD_ON_RST           0x0
#define RPL_DPLL_VCO_ON_RST          0x1
#define RPL_DPLL_CP_ON_RST           0x0

__INLINE void rpl_dpllcntl0_pack(uint8_t forcedpllctrl, uint8_t dpllibvcobuffer, uint8_t dpllkvcosel, uint8_t dpllibvco, uint8_t dpllldon, uint8_t dpllvcoon, uint8_t dpllcpon)
{
    ASSERT_ERR((((uint32_t)forcedpllctrl << 31) & ~((uint32_t)0x80000000)) == 0);
    ASSERT_ERR((((uint32_t)dpllibvcobuffer << 12) & ~((uint32_t)0x00003000)) == 0);
    ASSERT_ERR((((uint32_t)dpllkvcosel << 8) & ~((uint32_t)0x00000300)) == 0);
    ASSERT_ERR((((uint32_t)dpllibvco << 4) & ~((uint32_t)0x00000070)) == 0);
    ...
    REG_RPL_WR(RPL_DPLLCNTL0_ADDR,  ((uint32_t)forcedpllctrl << 31) | ((uint32_t)dpllibvcobuffer << 12) | ((uint32_t)dpllkvcosel << 8) | ((uint32_t)dpllibvco << 4) | ((uint32_t)dpllldon << 3) | ((uint32_t)dpllvcoon << 2) | ((uint32_t)dpllcpon << 1));
}

__INLINE void rpl_dpllcntl0_unpack(uint8_t* forcedpllctrl, uint8_t* dpllibvcobuffer, uint8_t* dpllkvcosel, uint8_t* dpllibvco, uint8_t* dpllldon, uint8_t* dpllvcoon, uint8_t* dpllcpon)
{
    uint32_t localVal;

    localVal = REG_RPL_RD(RPL_DPLLCNTL0_ADDR);
    *forcedpllctrl = (localVal & ((uint32_t)0x80000000)) >> 31;
    *dpllibvcobuffer = (localVal & ((uint32_t)0x00003000)) >> 12;
    *dpllkvcosel = (localVal & ((uint32_t)0x00000300)) >> 8;
    *dpllibvco = (localVal & ((uint32_t)0x00000070)) >> 4;
...
__INLINE uint8_t rpl_dpll_ibvco_buffer_getf(void)
{
    uint32_t localVal;
...
__INLINE void rpl_dpll_ibvco_buffer_setf(uint8_t dpllibvcobuffer)
{
    ASSERT_ERR((((uint32_t)dpllibvcobuffer << 12) & ~((uint32_t)0x00003000)) == 0);
    REG_RPL_WR(RPL_DPLLCNTL0_ADDR, (REG_RPL_RD(RPL_DPLLCNTL0_ADDR) & ~((uint32_t)0x00003000)) | ((uint32_t)dpllibvcobuffer << 12));
}

__INLINE uint8_t rpl_dpll_kvco_sel_getf(void)
{
    uint32_t localVal;
...
__INLINE void rpl_dpll_kvco_sel_setf(uint8_t dpllkvcosel)
{
    ASSERT_ERR((((uint32_t)dpllkvcosel << 8) & ~((uint32_t)0x00000300)) == 0);
    REG_RPL_WR(RPL_DPLLCNTL0_ADDR, (REG_RPL_RD(RPL_DPLLCNTL0_ADDR) & ~((uint32_t)0x00000300)) | ((uint32_t)dpllkvcosel << 8));
}

__INLINE uint8_t rpl_dpll_ibvco_getf(void)
{
    uint32_t localVal;
...
__INLINE void rpl_dpll_ibvco_setf(uint8_t dpllibvco)
{
    ASSERT_ERR((((uint32_t)dpllibvco << 4) & ~((uint32_t)0x00000070)) == 0);
    REG_RPL_WR(RPL_DPLLCNTL0_ADDR, (REG_RPL_RD(RPL_DPLLCNTL0_ADDR) & ~((uint32_t)0x00000070)) | ((uint32_t)dpllibvco << 4));
}
...
__INLINE void rpl_dpllcntl1_unpack(uint8_t* dplldivr, uint8_t* dplldivp, uint16_t* dpllnfract, uint8_t* dpllnint)
{
    ...
    localVal = REG_RPL_RD(RPL_DPLLCNTL1_ADDR);
 ...
 *  14:12      DPLL_ICP_OFFSET   0x4
 *     11         DPLL_VCO_CFG   0
 *  10:08         DPLL_PFD_CFG   0x0
 *  07:04             DPLL_ICP   0x4
 *     03         DPLL_TEST_EN   0
 *     02   DPLL_VCO_SPEEDUP_EN   1
 *     01        DPLL_FRACT_EN   0
 *     00          DPLL_DTP_EN   0
 * </pre>
 */
...
#define RPL_DPLLCNTL2_RESET  0x00014044
...
// field definitions
#define RPL_BBPLL_DIVN_BIT             ((uint32_t)0x00100000)
#define RPL_BBPLL_DIVN_POS             20
...
#define RPL_BBPLL_DIVN_RST             0x0
#define RPL_DPLL_SDORDER_RST           0x1
#define RPL_DPLL_ICP_OFFSET_RST        0x4
#define RPL_DPLL_VCO_CFG_RST           0x0
#define RPL_DPLL_PFD_CFG_RST           0x0
#define RPL_DPLL_ICP_RST               0x4
#define RPL_DPLL_TEST_EN_RST           0x0
#define RPL_DPLL_VCO_SPEEDUP_EN_RST    0x1
#define RPL_DPLL_FRACT_EN_RST          0x0
#define RPL_DPLL_DTP_EN_RST            0x0

__INLINE void rpl_dpllcntl2_pack(uint8_t bbplldivn, uint8_t dpllsdorder, uint8_t dpllicpoffset, uint8_t dpllvcocfg, uint8_t dpllpfdcfg, uint8_t dpllicp, uint8_t dplltesten, uint8_t dpllvcospeedupen, uint8_t dpllfracten, uint8_t dplldtpen)
{
    ASSERT_ERR((((uint32_t)bbplldivn << 20) & ~((uint32_t)0x00100000)) == 0);
    ...
    REG_RPL_WR(RPL_DPLLCNTL2_ADDR,  ((uint32_t)bbplldivn << 20) | ((uint32_t)dpllsdorder << 16) | ((uint32_t)dpllicpoffset << 12) | ((uint32_t)dpllvcocfg << 11) | ((uint32_t)dpllpfdcfg << 8) | ((uint32_t)dpllicp << 4) | ((uint32_t)dplltesten << 3) | ((uint32_t)dpllvcospeedupen << 2) | ((uint32_t)dpllfracten << 1) | ((uint32_t)dplldtpen << 0));
}

__INLINE void rpl_dpllcntl2_unpack(uint8_t* bbplldivn, uint8_t* dpllsdorder, uint8_t* dpllicpoffset, uint8_t* dpllvcocfg, uint8_t* dpllpfdcfg, uint8_t* dpllicp, uint8_t* dplltesten, uint8_t* dpllvcospeedupen, uint8_t* dpllfracten, uint8_t* dplldtpen)
{
    uint32_t localVal;

    localVal = REG_RPL_RD(RPL_DPLLCNTL2_ADDR);
    *bbplldivn = (localVal & ((uint32_t)0x00100000)) >> 20;
...
__INLINE uint8_t rpl_bbpll_divn_getf(void)
{
    uint32_t localVal;
...
__INLINE void rpl_bbpll_divn_setf(uint8_t bbplldivn)
{
    ASSERT_ERR((((uint32_t)bbplldivn << 20) & ~((uint32_t)0x00100000)) == 0);
    REG_RPL_WR(RPL_DPLLCNTL2_ADDR, (REG_RPL_RD(RPL_DPLLCNTL2_ADDR) & ~((uint32_t)0x00100000)) | ((uint32_t)bbplldivn << 20));
}
...
#define RPL_DPLL_LD_UNLOCK_CNT_RST         0x3
#define RPL_DPLL_LD_LOCK_CNT_RST           0x46
...
__INLINE void rpl_dpllcntl3_unpack(uint8_t* dpllldfrefclkinven, uint8_t* dpllldfdivclkinven, uint8_t* dpllldedgescomb, uint8_t* dpllldfe, uint8_t* dpllldre, uint8_t* dpllldunlockcnt, uint8_t* dpllldlockcnt)
{
    ...
    localVal = REG_RPL_RD(RPL_DPLLCNTL3_ADDR);
...
__INLINE void rpl_dpllstat_unpack(uint8_t* dpllvcoclkok, uint8_t* dplllockdetect)
{
    ...
    localVal = REG_RPL_RD(RPL_DPLLSTAT_ADDR);
 ...
 *   Bits           Field Name   Reset Value
 *  -----   ------------------   -----------
 *  31:28          FILT_RC_VAL   0x7
 *  27:24          RPLL_RC_VAL   0x8
...
#define RPL_RC_CALIB_CNTL_RESET  0x78000000
...
#define RPL_FILT_RC_VAL_RST          0x7
#define RPL_RPLL_RC_VAL_RST          0x8
...
__INLINE void rpl_rc_calib_cntl_unpack(uint8_t* filtrcval, uint8_t* rpllrcval, uint8_t* dpllrcval, uint8_t* filtrccalclken, uint8_t* rpllrccalclken, uint8_t* dpllrccalclken, uint8_t* filtrccalnosc, uint8_t* rpllrccalnosc, uint8_t* dpllrccalnosc, uint8_t* filtrccalon, uint8_t* rpllrccalon, uint8_t* dpllrccalon)
{
    ...
    localVal = REG_RPL_RD(RPL_RC_CALIB_CNTL_ADDR);
...
__INLINE void rpl_pll_rc_calib_stat_unpack(uint16_t* rpllrccalbtunestat, uint8_t* rpllrccaldone, uint16_t* dpllrccalbtunestat, uint8_t* dpllrccaldone)
{
    ...
    localVal = REG_RPL_RD(RPL_PLL_RC_CALIB_STAT_ADDR);
...
__INLINE void rpl_filter_rc_calib_stat_unpack(uint16_t* filtrccalbtunestat, uint8_t* filtrccaldone)
{
    ...
    localVal = REG_RPL_RD(RPL_FILTER_RC_CALIB_STAT_ADDR);
...
__INLINE void rpl_vcofc_icp_calibcntl_unpack(uint8_t* lutldin, uint8_t* luticpin, uint8_t* lutvcofcin, uint8_t* lutvcofcicpwen, uint8_t* lutvcofcicpadd)
{
    ...
    localVal = REG_RPL_RD(RPL_VCOFC_ICP_CALIBCNTL_ADDR);
...
__INLINE void rpl_vcofc_icp_calibconfig_unpack(uint8_t* kvcostepden, uint8_t* kvcostepnum, uint8_t* icpcalsign, uint16_t* kvcoref)
{
    ...
    localVal = REG_RPL_RD(RPL_VCOFC_ICP_CALIBCONFIG_ADDR);
...
// field definitions
#define RPL_LUT_VCOFC_VALH_BIT    ((uint32_t)0x00000200)
#define RPL_LUT_VCOFC_VALH_POS    9
...
#define RPL_LUT_VCOFC_VALH_RST    0x0
#define RPL_LUT_LD_VAL_RST        0x0
#define RPL_LUT_ICP_VAL_RST       0x0
#define RPL_LUT_VCOFC_VAL_RST     0x0

__INLINE void rpl_vcofc_icp_calibstat_unpack(uint8_t* lutvcofcvalh, uint8_t* lutldval, uint8_t* luticpval, uint8_t* lutvcofcval)
{
    uint32_t localVal;

    localVal = REG_RPL_RD(RPL_VCOFC_ICP_CALIBSTAT_ADDR);
    *lutvcofcvalh = (localVal & ((uint32_t)0x00000200)) >> 9;
...
__INLINE uint8_t rpl_lut_vcofc_valh_getf(void)
{
    uint32_t localVal;
...
__INLINE void rpl_txdc_calibcntl_unpack(uint8_t* luttxdcsel, uint8_t* luttxdcqin, uint8_t* luttxdciin, uint8_t* luttxdcwen, uint8_t* luttxdcadd)
{
    ...
    localVal = REG_RPL_RD(RPL_TXDC_CALIBCNTL_ADDR);
...
__INLINE void rpl_txdc_calibstat_unpack(uint8_t* luttxdcq8dpskval, uint8_t* luttxdci8dpskval, uint8_t* luttxdcqdqpskval, uint8_t* luttxdcidqpskval, uint8_t* luttxdcqgfskval, uint8_t* luttxdcigfskval)
{
    ...
    localVal = REG_RPL_RD(RPL_TXDC_CALIBSTAT_ADDR);
 ...
 *     18   FORCE_RSSI_PRELOAD   0
 *     17      RSSI_PRELOAD_EN   0
 *  16:12     RSSI_PRELOAD_CNT   0x10
 *  11:08     RSSI_ON_DLYD_CNT   0xD
...
#define RPL_AGC_RSSI_CONFIG_RESET  0x80010D40
...
#define RPL_FORCE_RSSI_PRELOAD_BIT    ((uint32_t)0x00040000)
#define RPL_FORCE_RSSI_PRELOAD_POS    18
#define RPL_RSSI_PRELOAD_EN_BIT       ((uint32_t)0x00020000)
#define RPL_RSSI_PRELOAD_EN_POS       17
...
#define RPL_FORCE_RSSI_PRELOAD_RST    0x0
#define RPL_RSSI_PRELOAD_EN_RST       0x0
#define RPL_RSSI_PRELOAD_CNT_RST      0x10
#define RPL_RSSI_ON_DLYD_CNT_RST      0xD
#define RPL_AGC_SETTLE_TIME_RST       0x40

__INLINE void rpl_agc_rssi_config_pack(uint8_t rxagcsatdetmode, uint8_t forcerssipreload, uint8_t rssipreloaden, uint8_t rssipreloadcnt, uint8_t rssiondlydcnt, uint8_t agcsettletime)
{
    ASSERT_ERR((((uint32_t)rxagcsatdetmode << 31) & ~((uint32_t)0x80000000)) == 0);
    ASSERT_ERR((((uint32_t)forcerssipreload << 18) & ~((uint32_t)0x00040000)) == 0);
    ASSERT_ERR((((uint32_t)rssipreloaden << 17) & ~((uint32_t)0x00020000)) == 0);
    ...
    REG_RPL_WR(RPL_AGC_RSSI_CONFIG_ADDR,  ((uint32_t)rxagcsatdetmode << 31) | ((uint32_t)forcerssipreload << 18) | ((uint32_t)rssipreloaden << 17) | ((uint32_t)rssipreloadcnt << 12) | ((uint32_t)rssiondlydcnt << 8) | ((uint32_t)agcsettletime << 0));
}

__INLINE void rpl_agc_rssi_config_unpack(uint8_t* rxagcsatdetmode, uint8_t* forcerssipreload, uint8_t* rssipreloaden, uint8_t* rssipreloadcnt, uint8_t* rssiondlydcnt, uint8_t* agcsettletime)
{
    uint32_t localVal;

    localVal = REG_RPL_RD(RPL_AGC_RSSI_CONFIG_ADDR);
    *rxagcsatdetmode = (localVal & ((uint32_t)0x80000000)) >> 31;
    *forcerssipreload = (localVal & ((uint32_t)0x00040000)) >> 18;
    *rssipreloaden = (localVal & ((uint32_t)0x00020000)) >> 17;
...
__INLINE uint8_t rpl_force_rssi_preload_getf(void)
{
    uint32_t localVal;
...
__INLINE void rpl_force_rssi_preload_setf(uint8_t forcerssipreload)
{
    ASSERT_ERR((((uint32_t)forcerssipreload << 18) & ~((uint32_t)0x00040000)) == 0);
    REG_RPL_WR(RPL_AGC_RSSI_CONFIG_ADDR, (REG_RPL_RD(RPL_AGC_RSSI_CONFIG_ADDR) & ~((uint32_t)0x00040000)) | ((uint32_t)forcerssipreload << 18));
}

__INLINE uint8_t rpl_rssi_preload_en_getf(void)
{
    uint32_t localVal;
...
__INLINE void rpl_rssi_preload_en_setf(uint8_t rssipreloaden)
{
    ASSERT_ERR((((uint32_t)rssipreloaden << 17) & ~((uint32_t)0x00020000)) == 0);
    REG_RPL_WR(RPL_AGC_RSSI_CONFIG_ADDR, (REG_RPL_RD(RPL_AGC_RSSI_CONFIG_ADDR) & ~((uint32_t)0x00020000)) | ((uint32_t)rssipreloaden << 17));
}
...
// field definitions
#define RPL_AGC_RXGAIN_MASK   ((uint32_t)0x0000000F)
#define RPL_AGC_RXGAIN_LSB    0
#define RPL_AGC_RXGAIN_WIDTH  ((uint32_t)0x00000004)
...
__INLINE uint8_t rpl_agc_rxgain_getf(void)
{
    ...
    localVal = REG_RPL_RD(RPL_AGC_STAT_ADDR);
...
#define RPL_RFRXGAINTABLE_RESET  0x00000377
...
#define RPL_RXMIX_GAIN_MASK      ((uint32_t)0x00000070)
#define RPL_RXMIX_GAIN_LSB       4
#define RPL_RXMIX_GAIN_WIDTH     ((uint32_t)0x00000003)
...
__INLINE void rpl_rfrxgaintable_pack(int reg_idx, uint8_t rxlnagain, uint8_t rxmixgain, uint8_t rxfiltergain)
{
    ...
    ASSERT_ERR((((uint32_t)rxmixgain << 4) & ~((uint32_t)0x00000070)) == 0);
...
__INLINE void rpl_rfrxgaintable_unpack(int reg_idx, uint8_t* rxlnagain, uint8_t* rxmixgain, uint8_t* rxfiltergain)
{
    ...
    localVal = REG_RPL_RD(RPL_RFRXGAINTABLE_ADDR + reg_idx * 1);
    *rxlnagain = (localVal & ((uint32_t)0x00000300)) >> 8;
    *rxmixgain = (localVal & ((uint32_t)0x00000070)) >> 4;
...
{
    ASSERT_ERR((((uint32_t)rxmixgain << 4) & ~((uint32_t)0x00000070)) == 0);
    REG_RPL_WR(RPL_RFRXGAINTABLE_ADDR + reg_idx * 1, (REG_RPL_RD(RPL_RFRXGAINTABLE_ADDR + reg_idx * 1) & ~((uint32_t)0x00000070)) | ((uint32_t)rxmixgain << 4));
}
 ...
 *   Bits           Field Name   Reset Value
 *  -----   ------------------   -----------
 *  30:28        LDO_RXTX_TRIM   0x4
 *  27:25        LDO_VDIG_TRIM   0x0
 *  24:22        LDO_ADDA_TRIM   0x4
 *  21:19         LDO_VCO_TRIM   0x4
 *  18:16          LDO_XO_TRIM   0x0
 *  15:13         LDO_PLL_TRIM   0x4
...
#define RPL_RFPOWER_CNTL_RESET  0x41208001
...
#define RPL_LDO_RXTX_TRIM_RST       0x4
#define RPL_LDO_VDIG_TRIM_RST       0x0
#define RPL_LDO_ADDA_TRIM_RST       0x4
#define RPL_LDO_VCO_TRIM_RST        0x4
#define RPL_LDO_XO_TRIM_RST         0x0
#define RPL_LDO_PLL_TRIM_RST        0x4
...
__INLINE void rpl_rfpower_cntl_unpack(uint8_t* ldorxtxtrim, uint8_t* ldovdigtrim, uint8_t* ldoaddatrim, uint8_t* ldovcotrim, uint8_t* ldoxotrim, uint8_t* ldoplltrim, uint8_t* ldobgaptrim, uint8_t* ldorxtxlpmode, uint8_t* ldaaddalpmode, uint8_t* ldovcolpmode, uint8_t* ldoplllpmode, uint8_t* ldoxolpmode, uint8_t* ldorxtxon, uint8_t* ldoaddaon, uint8_t* ldovcoon, uint8_t* ldopllon, uint8_t* ldoxoon)
{
    ...
    localVal = REG_RPL_RD(RPL_RFPOWER_CNTL_ADDR);
...
#define RPL_EDR_SWITCH_CNT_MASK   ((uint32_t)0x3FF00000)
#define RPL_EDR_SWITCH_CNT_LSB    20
#define RPL_EDR_SWITCH_CNT_WIDTH  ((uint32_t)0x0000000A)
...
__INLINE void rpl_rampgencntl_pack(uint8_t epcmode, uint16_t edrswitchcnt, uint8_t gaindec, uint8_t gainincr)
{
    ...
    ASSERT_ERR((((uint32_t)edrswitchcnt << 20) & ~((uint32_t)0x3FF00000)) == 0);
...
__INLINE void rpl_rampgencntl_unpack(uint8_t* epcmode, uint16_t* edrswitchcnt, uint8_t* gaindec, uint8_t* gainincr)
{
    ...
    localVal = REG_RPL_RD(RPL_RAMPGENCNTL_ADDR);
    *epcmode = (localVal & ((uint32_t)0xC0000000)) >> 30;
    *edrswitchcnt = (localVal & ((uint32_t)0x3FF00000)) >> 20;
...
{
    ASSERT_ERR((((uint32_t)edrswitchcnt << 20) & ~((uint32_t)0x3FF00000)) == 0);
    REG_RPL_WR(RPL_RAMPGENCNTL_ADDR, (REG_RPL_RD(RPL_RAMPGENCNTL_ADDR) & ~((uint32_t)0x3FF00000)) | ((uint32_t)edrswitchcnt << 20));
}
 ...
 *  06:04     TX_GFSK_DRV_GAIN   0x0
 *  02:00   TX_GFSK_FILTER_GAIN   0x4
 * </pre>
 */
...
#define RPL_RFTX_GFSK_GAIN_TABLE_RESET  0x00000004
...
#define RPL_TX_GFSK_DRV_GAIN_RST       0x0
#define RPL_TX_GFSK_FILTER_GAIN_RST    0x4
...
__INLINE void rpl_rftx_gfsk_gain_table_unpack(int reg_idx, uint8_t* txgfskpaintgain, uint8_t* txgfskdrvgain, uint8_t* txgfskfiltergain)
{
    ...
    localVal = REG_RPL_RD(RPL_RFTX_GFSK_GAIN_TABLE_ADDR + reg_idx * 1);
 ...
 *  18:16    TX_DQPSK_DRV_GAIN   0x0
 *  14:12   TX_DQPSK_FILTER_GAIN   0x4
 *  10:08   TX_8DPSK_PAINT_GAIN   0x0
 *  06:04    TX_8DPSK_DRV_GAIN   0x0
 *  02:00   TX_8DPSK_FILTER_GAIN   0x4
 * </pre>
 */
...
#define RPL_RFTX_EDR_GAIN_TABLE_RESET  0x00004004
...
#define RPL_TX_DQPSK_DRV_GAIN_RST       0x0
#define RPL_TX_DQPSK_FILTER_GAIN_RST    0x4
#define RPL_TX_8DPSK_PAINT_GAIN_RST     0x0
#define RPL_TX_8DPSK_DRV_GAIN_RST       0x0
#define RPL_TX_8DPSK_FILTER_GAIN_RST    0x4
...
__INLINE void rpl_rftx_edr_gain_table_unpack(int reg_idx, uint8_t* txdqpskpaintgain, uint8_t* txdqpskdrvgain, uint8_t* txdqpskfiltergain, uint8_t* tx8dpskpaintgain, uint8_t* tx8dpskdrvgain, uint8_t* tx8dpskfiltergain)
{
    ...
    localVal = REG_RPL_RD(RPL_RFTX_EDR_GAIN_TABLE_ADDR + reg_idx * 1);
 ...
 *   Bits           Field Name   Reset Value
 *  -----   ------------------   -----------
 *  22:20    TXDACQ_8DPSK_GAIN   0x4
 *  18:16    TXDACI_8DPSK_GAIN   0x4
 *  14:12    TXDACQ_DQPSK_GAIN   0x4
 *  10:08    TXDACI_DQPSK_GAIN   0x4
 *  06:04     TXDACQ_GFSK_GAIN   0x4
 *  02:00     TXDACI_GFSK_GAIN   0x4
 * </pre>
 */
...
#define RPL_RFTX_DACIQ_GAIN_RESET  0x00444444
...
#define RPL_TXDACQ_8DPSK_GAIN_RST    0x4
#define RPL_TXDACI_8DPSK_GAIN_RST    0x4
#define RPL_TXDACQ_DQPSK_GAIN_RST    0x4
#define RPL_TXDACI_DQPSK_GAIN_RST    0x4
#define RPL_TXDACQ_GFSK_GAIN_RST     0x4
#define RPL_TXDACI_GFSK_GAIN_RST     0x4
...
__INLINE void rpl_rftx_daciq_gain_unpack(uint8_t* txdacq8dpskgain, uint8_t* txdaci8dpskgain, uint8_t* txdacqdqpskgain, uint8_t* txdacidqpskgain, uint8_t* txdacqgfskgain, uint8_t* txdacigfskgain)
{
    ...
    localVal = REG_RPL_RD(RPL_RFTX_DACIQ_GAIN_ADDR);
...
__INLINE void rpl_crm_cntl0_unpack(uint8_t* forceresets, uint8_t* forceclockgates, uint8_t* daptxdcrsten, uint8_t* rpllfdivrsten, uint8_t* mdmrsten, uint8_t* dbrsten, uint8_t* agcrsten, uint8_t* sdrsten, uint8_t* gfskprefiltrsten, uint8_t* dapcalibrsten, uint8_t* daprsten, uint8_t* daptxdcclkgateen, uint8_t* rpllfdivclkgateen, uint8_t* saradcclkgateen, uint8_t* mdmtxdpsk13clkgateen, uint8_t* mdmtxgfsk13clkgateen, uint8_t* mdmtx13clkgateen, uint8_t* mdmrxdpsk13clkgateen, uint8_t* mdmrxdpsk52clkgateen, uint8_t* mdmrxdl13clkgateen, uint8_t* mdmrxgfsk13clkgateen, uint8_t* mdmrxgfsk52clkgateen, uint8_t* mdmrx52clkgateen, uint8_t* mdmcore13clkgateen, uint8_t* dbclkgateen, uint8_t* agcclkgateen, uint8_t* sdclkgateen, uint8_t* gfskprefiltclkgateen, uint8_t* dapcalibclkgateen, uint8_t* dapclkgateen)
{
    ...
    localVal = REG_RPL_RD(RPL_CRM_CNTL0_ADDR);
 ...
 *  -----   ------------------   -----------
 *     31       FORCE_CRM_CTRL   0
 *  25:24      CLK_SWITCH_CTRL   0x2
 *     23              DPLL_EN   0
 *     19     N_FILT_RCCAL_RST   0
 *     18     N_RPLL_RCCAL_RST   0
 *     17   N_DCOFFSET_FSM_RST   0
 *     16       N_RPLL_FSM_RST   0
 *     13   SAR_ADC_LOWCLK_SEL   0
 *     12      SAR_ADC_CLK_SEL   0
 *  09:08           BB_CLK_DIV   0x2
 *     05        N_SAR_ADC_RST   0
 *     04     N_RPLL_LOCNT_RST   0
 *     03        N_RPLL_LD_RST   0
 *     02         N_CLKGEN_RST   1
 *     01           N_DPLL_RST   1
 *     00              LP_MODE   0
...
#define RPL_CRM_CNTL1_RESET  0x02000206
...
#define RPL_N_FILT_RCCAL_RST_BIT      ((uint32_t)0x00080000)
#define RPL_N_FILT_RCCAL_RST_POS      19
#define RPL_N_RPLL_RCCAL_RST_BIT      ((uint32_t)0x00040000)
#define RPL_N_RPLL_RCCAL_RST_POS      18
#define RPL_N_DCOFFSET_FSM_RST_BIT    ((uint32_t)0x00020000)
#define RPL_N_DCOFFSET_FSM_RST_POS    17
#define RPL_N_RPLL_FSM_RST_BIT        ((uint32_t)0x00010000)
#define RPL_N_RPLL_FSM_RST_POS        16
#define RPL_SAR_ADC_LOWCLK_SEL_BIT    ((uint32_t)0x00002000)
#define RPL_SAR_ADC_LOWCLK_SEL_POS    13
...
#define RPL_N_SAR_ADC_RST_BIT         ((uint32_t)0x00000020)
#define RPL_N_SAR_ADC_RST_POS         5
#define RPL_N_RPLL_LOCNT_RST_BIT      ((uint32_t)0x00000010)
#define RPL_N_RPLL_LOCNT_RST_POS      4
#define RPL_N_RPLL_LD_RST_BIT         ((uint32_t)0x00000008)
#define RPL_N_RPLL_LD_RST_POS         3
#define RPL_N_CLKGEN_RST_BIT          ((uint32_t)0x00000004)
#define RPL_N_CLKGEN_RST_POS          2
#define RPL_N_DPLL_RST_BIT            ((uint32_t)0x00000002)
#define RPL_N_DPLL_RST_POS            1
#define RPL_LP_MODE_BIT               ((uint32_t)0x00000001)
#define RPL_LP_MODE_POS               0

#define RPL_FORCE_CRM_CTRL_RST        0x0
#define RPL_CLK_SWITCH_CTRL_RST       0x2
#define RPL_DPLL_EN_RST               0x0
#define RPL_N_FILT_RCCAL_RST_RST      0x0
#define RPL_N_RPLL_RCCAL_RST_RST      0x0
#define RPL_N_DCOFFSET_FSM_RST_RST    0x0
#define RPL_N_RPLL_FSM_RST_RST        0x0
#define RPL_SAR_ADC_LOWCLK_SEL_RST    0x0
#define RPL_SAR_ADC_CLK_SEL_RST       0x0
#define RPL_BB_CLK_DIV_RST            0x2
#define RPL_N_SAR_ADC_RST_RST         0x0
#define RPL_N_RPLL_LOCNT_RST_RST      0x0
#define RPL_N_RPLL_LD_RST_RST         0x0
#define RPL_N_CLKGEN_RST_RST          0x1
#define RPL_N_DPLL_RST_RST            0x1
#define RPL_LP_MODE_RST               0x0

__INLINE void rpl_crm_cntl1_pack(uint8_t forcecrmctrl, uint8_t clkswitchctrl, uint8_t dpllen, uint8_t nfiltrccalrst, uint8_t nrpllrccalrst, uint8_t ndcoffsetfsmrst, uint8_t nrpllfsmrst, uint8_t saradclowclksel, uint8_t saradcclksel, uint8_t bbclkdiv, uint8_t nsaradcrst, uint8_t nrplllocntrst, uint8_t nrpllldrst, uint8_t nclkgenrst, uint8_t ndpllrst, uint8_t lpmode)
{
    ...
    ASSERT_ERR((((uint32_t)nfiltrccalrst << 19) & ~((uint32_t)0x00080000)) == 0);
    ASSERT_ERR((((uint32_t)nrpllrccalrst << 18) & ~((uint32_t)0x00040000)) == 0);
    ASSERT_ERR((((uint32_t)ndcoffsetfsmrst << 17) & ~((uint32_t)0x00020000)) == 0);
    ASSERT_ERR((((uint32_t)nrpllfsmrst << 16) & ~((uint32_t)0x00010000)) == 0);
    ASSERT_ERR((((uint32_t)saradclowclksel << 13) & ~((uint32_t)0x00002000)) == 0);
    ASSERT_ERR((((uint32_t)saradcclksel << 12) & ~((uint32_t)0x00001000)) == 0);
    ASSERT_ERR((((uint32_t)bbclkdiv << 8) & ~((uint32_t)0x00000300)) == 0);
    ASSERT_ERR((((uint32_t)nsaradcrst << 5) & ~((uint32_t)0x00000020)) == 0);
    ASSERT_ERR((((uint32_t)nrplllocntrst << 4) & ~((uint32_t)0x00000010)) == 0);
    ASSERT_ERR((((uint32_t)nrpllldrst << 3) & ~((uint32_t)0x00000008)) == 0);
    ASSERT_ERR((((uint32_t)nclkgenrst << 2) & ~((uint32_t)0x00000004)) == 0);
    ASSERT_ERR((((uint32_t)ndpllrst << 1) & ~((uint32_t)0x00000002)) == 0);
    ASSERT_ERR((((uint32_t)lpmode << 0) & ~((uint32_t)0x00000001)) == 0);
    REG_RPL_WR(RPL_CRM_CNTL1_ADDR,  ((uint32_t)forcecrmctrl << 31) | ((uint32_t)clkswitchctrl << 24) | ((uint32_t)dpllen << 23) | ((uint32_t)nfiltrccalrst << 19) | ((uint32_t)nrpllrccalrst << 18) | ((uint32_t)ndcoffsetfsmrst << 17) | ((uint32_t)nrpllfsmrst << 16) | ((uint32_t)saradclowclksel << 13) | ((uint32_t)saradcclksel << 12) | ((uint32_t)bbclkdiv << 8) | ((uint32_t)nsaradcrst << 5) | ((uint32_t)nrplllocntrst << 4) | ((uint32_t)nrpllldrst << 3) | ((uint32_t)nclkgenrst << 2) | ((uint32_t)ndpllrst << 1) | ((uint32_t)lpmode << 0));
}

__INLINE void rpl_crm_cntl1_unpack(uint8_t* forcecrmctrl, uint8_t* clkswitchctrl, uint8_t* dpllen, uint8_t* nfiltrccalrst, uint8_t* nrpllrccalrst, uint8_t* ndcoffsetfsmrst, uint8_t* nrpllfsmrst, uint8_t* saradclowclksel, uint8_t* saradcclksel, uint8_t* bbclkdiv, uint8_t* nsaradcrst, uint8_t* nrplllocntrst, uint8_t* nrpllldrst, uint8_t* nclkgenrst, uint8_t* ndpllrst, uint8_t* lpmode)
{
    uint32_t localVal;

    localVal = REG_RPL_RD(RPL_CRM_CNTL1_ADDR);
    ...
    *nfiltrccalrst = (localVal & ((uint32_t)0x00080000)) >> 19;
    *nrpllrccalrst = (localVal & ((uint32_t)0x00040000)) >> 18;
    *ndcoffsetfsmrst = (localVal & ((uint32_t)0x00020000)) >> 17;
    *nrpllfsmrst = (localVal & ((uint32_t)0x00010000)) >> 16;
    *saradclowclksel = (localVal & ((uint32_t)0x00002000)) >> 13;
    *saradcclksel = (localVal & ((uint32_t)0x00001000)) >> 12;
    *bbclkdiv = (localVal & ((uint32_t)0x00000300)) >> 8;
    *nsaradcrst = (localVal & ((uint32_t)0x00000020)) >> 5;
    *nrplllocntrst = (localVal & ((uint32_t)0x00000010)) >> 4;
    *nrpllldrst = (localVal & ((uint32_t)0x00000008)) >> 3;
    *nclkgenrst = (localVal & ((uint32_t)0x00000004)) >> 2;
    *ndpllrst = (localVal & ((uint32_t)0x00000002)) >> 1;
...
__INLINE uint8_t rpl_n_filt_rccal_rst_getf(void)
{
    uint32_t localVal;
...
__INLINE void rpl_n_filt_rccal_rst_setf(uint8_t nfiltrccalrst)
{
    ASSERT_ERR((((uint32_t)nfiltrccalrst << 19) & ~((uint32_t)0x00080000)) == 0);
    REG_RPL_WR(RPL_CRM_CNTL1_ADDR, (REG_RPL_RD(RPL_CRM_CNTL1_ADDR) & ~((uint32_t)0x00080000)) | ((uint32_t)nfiltrccalrst << 19));
}

__INLINE uint8_t rpl_n_rpll_rccal_rst_getf(void)
{
    uint32_t localVal;
...
__INLINE void rpl_n_rpll_rccal_rst_setf(uint8_t nrpllrccalrst)
{
    ASSERT_ERR((((uint32_t)nrpllrccalrst << 18) & ~((uint32_t)0x00040000)) == 0);
    REG_RPL_WR(RPL_CRM_CNTL1_ADDR, (REG_RPL_RD(RPL_CRM_CNTL1_ADDR) & ~((uint32_t)0x00040000)) | ((uint32_t)nrpllrccalrst << 18));
}

__INLINE uint8_t rpl_n_dcoffset_fsm_rst_getf(void)
{
    uint32_t localVal;
...
__INLINE void rpl_n_dcoffset_fsm_rst_setf(uint8_t ndcoffsetfsmrst)
{
    ASSERT_ERR((((uint32_t)ndcoffsetfsmrst << 17) & ~((uint32_t)0x00020000)) == 0);
    REG_RPL_WR(RPL_CRM_CNTL1_ADDR, (REG_RPL_RD(RPL_CRM_CNTL1_ADDR) & ~((uint32_t)0x00020000)) | ((uint32_t)ndcoffsetfsmrst << 17));
}

__INLINE uint8_t rpl_n_rpll_fsm_rst_getf(void)
{
    uint32_t localVal;
...
__INLINE void rpl_n_rpll_fsm_rst_setf(uint8_t nrpllfsmrst)
{
    ASSERT_ERR((((uint32_t)nrpllfsmrst << 16) & ~((uint32_t)0x00010000)) == 0);
    REG_RPL_WR(RPL_CRM_CNTL1_ADDR, (REG_RPL_RD(RPL_CRM_CNTL1_ADDR) & ~((uint32_t)0x00010000)) | ((uint32_t)nrpllfsmrst << 16));
}

__INLINE uint8_t rpl_sar_adc_lowclk_sel_getf(void)
{
    uint32_t localVal;
...
__INLINE void rpl_sar_adc_lowclk_sel_setf(uint8_t saradclowclksel)
{
    ASSERT_ERR((((uint32_t)saradclowclksel << 13) & ~((uint32_t)0x00002000)) == 0);
    REG_RPL_WR(RPL_CRM_CNTL1_ADDR, (REG_RPL_RD(RPL_CRM_CNTL1_ADDR) & ~((uint32_t)0x00002000)) | ((uint32_t)saradclowclksel << 13));
}
...
__INLINE uint8_t rpl_n_sar_adc_rst_getf(void)
{
    uint32_t localVal;
...
__INLINE void rpl_n_sar_adc_rst_setf(uint8_t nsaradcrst)
{
    ASSERT_ERR((((uint32_t)nsaradcrst << 5) & ~((uint32_t)0x00000020)) == 0);
    REG_RPL_WR(RPL_CRM_CNTL1_ADDR, (REG_RPL_RD(RPL_CRM_CNTL1_ADDR) & ~((uint32_t)0x00000020)) | ((uint32_t)nsaradcrst << 5));
}

__INLINE uint8_t rpl_n_rpll_locnt_rst_getf(void)
{
    uint32_t localVal;
...
__INLINE void rpl_n_rpll_locnt_rst_setf(uint8_t nrplllocntrst)
{
    ASSERT_ERR((((uint32_t)nrplllocntrst << 4) & ~((uint32_t)0x00000010)) == 0);
    REG_RPL_WR(RPL_CRM_CNTL1_ADDR, (REG_RPL_RD(RPL_CRM_CNTL1_ADDR) & ~((uint32_t)0x00000010)) | ((uint32_t)nrplllocntrst << 4));
}

__INLINE uint8_t rpl_n_rpll_ld_rst_getf(void)
{
    uint32_t localVal;
...
__INLINE void rpl_n_rpll_ld_rst_setf(uint8_t nrpllldrst)
{
    ASSERT_ERR((((uint32_t)nrpllldrst << 3) & ~((uint32_t)0x00000008)) == 0);
    REG_RPL_WR(RPL_CRM_CNTL1_ADDR, (REG_RPL_RD(RPL_CRM_CNTL1_ADDR) & ~((uint32_t)0x00000008)) | ((uint32_t)nrpllldrst << 3));
}

__INLINE uint8_t rpl_n_clkgen_rst_getf(void)
{
    uint32_t localVal;
...
__INLINE void rpl_n_clkgen_rst_setf(uint8_t nclkgenrst)
{
    ASSERT_ERR((((uint32_t)nclkgenrst << 2) & ~((uint32_t)0x00000004)) == 0);
    REG_RPL_WR(RPL_CRM_CNTL1_ADDR, (REG_RPL_RD(RPL_CRM_CNTL1_ADDR) & ~((uint32_t)0x00000004)) | ((uint32_t)nclkgenrst << 2));
}

__INLINE uint8_t rpl_n_dpll_rst_getf(void)
{
    uint32_t localVal;
...
__INLINE void rpl_n_dpll_rst_setf(uint8_t ndpllrst)
{
    ASSERT_ERR((((uint32_t)ndpllrst << 1) & ~((uint32_t)0x00000002)) == 0);
    REG_RPL_WR(RPL_CRM_CNTL1_ADDR, (REG_RPL_RD(RPL_CRM_CNTL1_ADDR) & ~((uint32_t)0x00000002)) | ((uint32_t)ndpllrst << 1));
}
 ...
 *     30         RXGAIN_FORCE   0
 *     29       FORCE_ADDA_RST   0
 *     25      RSSI_CLK_INV_EN   1
 *     24     RXADC_CLK_INV_EN   0
 *  23:20       RXADC_BIAS_CFG   0x1
 *     18       N_LDO_ADDA_RST   0
 *  15:14       RXADC_GAIN_CFG   0x0
...
#define RPL_RFRXCNTL_RESET  0x02100000
...
#define RPL_RXADC_BIAS_CFG_MASK     ((uint32_t)0x00F00000)
#define RPL_RXADC_BIAS_CFG_LSB      20
#define RPL_RXADC_BIAS_CFG_WIDTH    ((uint32_t)0x00000004)
#define RPL_N_LDO_ADDA_RST_BIT      ((uint32_t)0x00040000)
#define RPL_N_LDO_ADDA_RST_POS      18
#define RPL_RXADC_GAIN_CFG_MASK     ((uint32_t)0x0000C000)
#define RPL_RXADC_GAIN_CFG_LSB      14
#define RPL_RXADC_GAIN_CFG_WIDTH    ((uint32_t)0x00000002)
...
#define RPL_RSSI_CLK_INV_EN_RST     0x1
#define RPL_RXADC_CLK_INV_EN_RST    0x0
#define RPL_RXADC_BIAS_CFG_RST      0x1
#define RPL_N_LDO_ADDA_RST_RST      0x0
#define RPL_RXADC_GAIN_CFG_RST      0x0
...
__INLINE void rpl_rfrxcntl_pack(uint8_t rxctrlforce, uint8_t rxgainforce, uint8_t forceaddarst, uint8_t rssiclkinven, uint8_t rxadcclkinven, uint8_t rxadcbiascfg, uint8_t nldoaddarst, uint8_t rxadcgaincfg, uint8_t rxadcsatdeten, uint8_t modemrxen, uint8_t rxadcen, uint8_t rxadcon, uint8_t agcen, uint8_t rssion, uint8_t rxfilton, uint8_t rxlobufon, uint8_t rxmixon, uint8_t rxlnaon, uint8_t rxrfbiason, uint8_t rxgainsel)
{
    ...
    ASSERT_ERR((((uint32_t)rxadcbiascfg << 20) & ~((uint32_t)0x00F00000)) == 0);
    ASSERT_ERR((((uint32_t)nldoaddarst << 18) & ~((uint32_t)0x00040000)) == 0);
    ASSERT_ERR((((uint32_t)rxadcgaincfg << 14) & ~((uint32_t)0x0000C000)) == 0);
    ...
    REG_RPL_WR(RPL_RFRXCNTL_ADDR,  ((uint32_t)rxctrlforce << 31) | ((uint32_t)rxgainforce << 30) | ((uint32_t)forceaddarst << 29) | ((uint32_t)rssiclkinven << 25) | ((uint32_t)rxadcclkinven << 24) | ((uint32_t)rxadcbiascfg << 20) | ((uint32_t)nldoaddarst << 18) | ((uint32_t)rxadcgaincfg << 14) | ((uint32_t)rxadcsatdeten << 13) | ((uint32_t)modemrxen << 12) | ((uint32_t)rxadcen << 11) | ((uint32_t)rxadcon << 10) | ((uint32_t)agcen << 9) | ((uint32_t)rssion << 8) | ((uint32_t)rxfilton << 7) | ((uint32_t)rxlobufon << 6) | ((uint32_t)rxmixon << 5) | ((uint32_t)rxlnaon << 4) | ((uint32_t)rxrfbiason << 3) | ((uint32_t)rxgainsel << 0));
}

__INLINE void rpl_rfrxcntl_unpack(uint8_t* rxctrlforce, uint8_t* rxgainforce, uint8_t* forceaddarst, uint8_t* rssiclkinven, uint8_t* rxadcclkinven, uint8_t* rxadcbiascfg, uint8_t* nldoaddarst, uint8_t* rxadcgaincfg, uint8_t* rxadcsatdeten, uint8_t* modemrxen, uint8_t* rxadcen, uint8_t* rxadcon, uint8_t* agcen, uint8_t* rssion, uint8_t* rxfilton, uint8_t* rxlobufon, uint8_t* rxmixon, uint8_t* rxlnaon, uint8_t* rxrfbiason, uint8_t* rxgainsel)
{
    uint32_t localVal;

    localVal = REG_RPL_RD(RPL_RFRXCNTL_ADDR);
    ...
    *rxadcbiascfg = (localVal & ((uint32_t)0x00F00000)) >> 20;
    *nldoaddarst = (localVal & ((uint32_t)0x00040000)) >> 18;
    *rxadcgaincfg = (localVal & ((uint32_t)0x0000C000)) >> 14;
...
__INLINE uint8_t rpl_rxadc_bias_cfg_getf(void)
{
    uint32_t localVal;
...
__INLINE void rpl_rxadc_bias_cfg_setf(uint8_t rxadcbiascfg)
{
    ASSERT_ERR((((uint32_t)rxadcbiascfg << 20) & ~((uint32_t)0x00F00000)) == 0);
    REG_RPL_WR(RPL_RFRXCNTL_ADDR, (REG_RPL_RD(RPL_RFRXCNTL_ADDR) & ~((uint32_t)0x00F00000)) | ((uint32_t)rxadcbiascfg << 20));
}
...
__INLINE uint8_t rpl_rxadc_gain_cfg_getf(void)
{
    uint32_t localVal;
...
__INLINE void rpl_rxadc_gain_cfg_setf(uint8_t rxadcgaincfg)
{
    ASSERT_ERR((((uint32_t)rxadcgaincfg << 14) & ~((uint32_t)0x0000C000)) == 0);
    REG_RPL_WR(RPL_RFRXCNTL_ADDR, (REG_RPL_RD(RPL_RFRXCNTL_ADDR) & ~((uint32_t)0x0000C000)) | ((uint32_t)rxadcgaincfg << 14));
}
 ...
 *     29          RXLNA_CFG_H   0
 *     28         RXLNA_TRIM_H   0
 *  25:24           RXMIX_TRIM   0x3
 *  23:22           RXLNA_TRIM   0x1
 *  21:20            RXLNA_CFG   0x3
...
#define RPL_RFRXCONFIG_RESET  0x83700309
...
#define RPL_RXLNA_CFG_H_BIT     ((uint32_t)0x20000000)
#define RPL_RXLNA_CFG_H_POS     29
#define RPL_RXLNA_TRIM_H_BIT    ((uint32_t)0x10000000)
#define RPL_RXLNA_TRIM_H_POS    28
...
#define RPL_RXLNA_CFG_H_RST     0x0
#define RPL_RXLNA_TRIM_H_RST    0x0
#define RPL_RXMIX_TRIM_RST      0x3
#define RPL_RXLNA_TRIM_RST      0x1
#define RPL_RXLNA_CFG_RST       0x3
#define RPL_RXFILT_CFG_RST      0x0
#define RPL_RXADC_CFG_RST       0x3
#define RPL_RSSI_CFG_RST        0x9

__INLINE void rpl_rfrxconfig_pack(uint8_t rxfiltifen, uint8_t rxlnacfgh, uint8_t rxlnatrimh, uint8_t rxmixtrim, uint8_t rxlnatrim, uint8_t rxlnacfg, uint8_t rxfiltcfg, uint8_t rxadccfg, uint8_t rssicfg)
{
    ASSERT_ERR((((uint32_t)rxfiltifen << 31) & ~((uint32_t)0x80000000)) == 0);
    ASSERT_ERR((((uint32_t)rxlnacfgh << 29) & ~((uint32_t)0x20000000)) == 0);
    ASSERT_ERR((((uint32_t)rxlnatrimh << 28) & ~((uint32_t)0x10000000)) == 0);
    ...
    REG_RPL_WR(RPL_RFRXCONFIG_ADDR,  ((uint32_t)rxfiltifen << 31) | ((uint32_t)rxlnacfgh << 29) | ((uint32_t)rxlnatrimh << 28) | ((uint32_t)rxmixtrim << 24) | ((uint32_t)rxlnatrim << 22) | ((uint32_t)rxlnacfg << 20) | ((uint32_t)rxfiltcfg << 16) | ((uint32_t)rxadccfg << 8) | ((uint32_t)rssicfg << 0));
}

__INLINE void rpl_rfrxconfig_unpack(uint8_t* rxfiltifen, uint8_t* rxlnacfgh, uint8_t* rxlnatrimh, uint8_t* rxmixtrim, uint8_t* rxlnatrim, uint8_t* rxlnacfg, uint8_t* rxfiltcfg, uint8_t* rxadccfg, uint8_t* rssicfg)
{
    uint32_t localVal;

    localVal = REG_RPL_RD(RPL_RFRXCONFIG_ADDR);
    *rxfiltifen = (localVal & ((uint32_t)0x80000000)) >> 31;
    *rxlnacfgh = (localVal & ((uint32_t)0x20000000)) >> 29;
    *rxlnatrimh = (localVal & ((uint32_t)0x10000000)) >> 28;
...
__INLINE uint8_t rpl_rxlna_cfg_h_getf(void)
{
    uint32_t localVal;
...
__INLINE void rpl_rxlna_cfg_h_setf(uint8_t rxlnacfgh)
{
    ASSERT_ERR((((uint32_t)rxlnacfgh << 29) & ~((uint32_t)0x20000000)) == 0);
    REG_RPL_WR(RPL_RFRXCONFIG_ADDR, (REG_RPL_RD(RPL_RFRXCONFIG_ADDR) & ~((uint32_t)0x20000000)) | ((uint32_t)rxlnacfgh << 29));
}

__INLINE uint8_t rpl_rxlna_trim_h_getf(void)
{
    uint32_t localVal;
...
__INLINE void rpl_rxlna_trim_h_setf(uint8_t rxlnatrimh)
{
    ASSERT_ERR((((uint32_t)rxlnatrimh << 28) & ~((uint32_t)0x10000000)) == 0);
    REG_RPL_WR(RPL_RFRXCONFIG_ADDR, (REG_RPL_RD(RPL_RFRXCONFIG_ADDR) & ~((uint32_t)0x10000000)) | ((uint32_t)rxlnatrimh << 28));
}
...
__INLINE void rpl_rftxcntl0_unpack(uint8_t* txctrlforce, uint8_t* txgaingfskforce, uint8_t* txgainedrforce, uint8_t* txdacclkinven, uint8_t* txdccaltimeoutdsb, uint8_t* txdccalen, uint8_t* txdccalstart, uint8_t* sdfifoen, uint8_t* rampgenen, uint8_t* modemtxen, uint8_t* fmtx2pon, uint8_t* txfiltqon, uint8_t* txfiltion, uint8_t* txdacqon, uint8_t* txdacion, uint8_t* fmtxon, uint8_t* txpaon, uint8_t* txpasel, uint8_t* txrfdetecton, uint8_t* txmixon, uint8_t* txlobufon, uint8_t* txgainedrsel, uint8_t* txgaingfsksel)
{
    ...
    localVal = REG_RPL_RD(RPL_RFTXCNTL0_ADDR);
...
__INLINE void rpl_rftxcntl1_unpack(uint8_t* txdcforce, uint8_t* txdcq, uint8_t* txdci)
{
    ...
    localVal = REG_RPL_RD(RPL_RFTXCNTL1_ADDR);
 ...
 *  -----   ------------------   -----------
 *     31         TXFILT_IF_EN   1
 *  30:28   TXMIX_EDRBIAS_TRIM   0x3
 *  27:20   TXDC_CAL_TIMEOUT_DELAY   0xFF
 *  19:16   FMTX2P_ON_DLYD_CNT   0x0
 *  15:14            FMTX_TRIM   0x1
 *  13:12           TXMIX_TRIM   0x2
 *  10:08           TXTANK_SEL   0x2
...
#define RPL_RFTXCONFIG_RESET  0xBFF06206
...
#define RPL_TXMIX_EDRBIAS_TRIM_MASK       ((uint32_t)0x70000000)
#define RPL_TXMIX_EDRBIAS_TRIM_LSB        28
#define RPL_TXMIX_EDRBIAS_TRIM_WIDTH      ((uint32_t)0x00000003)
...
#define RPL_TXPA_CFG_MASK                 ((uint32_t)0x0000000F)
#define RPL_TXPA_CFG_LSB                  0
#define RPL_TXPA_CFG_WIDTH                ((uint32_t)0x00000004)

#define RPL_TXFILT_IF_EN_RST              0x1
#define RPL_TXMIX_EDRBIAS_TRIM_RST        0x3
#define RPL_TXDC_CAL_TIMEOUT_DELAY_RST    0xFF
#define RPL_FMTX2P_ON_DLYD_CNT_RST        0x0
#define RPL_FMTX_TRIM_RST                 0x1
#define RPL_TXMIX_TRIM_RST                0x2
#define RPL_TXTANK_SEL_RST                0x2
#define RPL_TXFILT_CFG_RST                0x0
#define RPL_TXPA_CFG_RST                  0x6

__INLINE void rpl_rftxconfig_pack(uint8_t txfiltifen, uint8_t txmixedrbiastrim, uint8_t txdccaltimeoutdelay, uint8_t fmtx2pondlydcnt, uint8_t fmtxtrim, uint8_t txmixtrim, uint8_t txtanksel, uint8_t txfiltcfg, uint8_t txpacfg)
{
    ASSERT_ERR((((uint32_t)txfiltifen << 31) & ~((uint32_t)0x80000000)) == 0);
    ASSERT_ERR((((uint32_t)txmixedrbiastrim << 28) & ~((uint32_t)0x70000000)) == 0);
    ...
    ASSERT_ERR((((uint32_t)txpacfg << 0) & ~((uint32_t)0x0000000F)) == 0);
    REG_RPL_WR(RPL_RFTXCONFIG_ADDR,  ((uint32_t)txfiltifen << 31) | ((uint32_t)txmixedrbiastrim << 28) | ((uint32_t)txdccaltimeoutdelay << 20) | ((uint32_t)fmtx2pondlydcnt << 16) | ((uint32_t)fmtxtrim << 14) | ((uint32_t)txmixtrim << 12) | ((uint32_t)txtanksel << 8) | ((uint32_t)txfiltcfg << 4) | ((uint32_t)txpacfg << 0));
}

__INLINE void rpl_rftxconfig_unpack(uint8_t* txfiltifen, uint8_t* txmixedrbiastrim, uint8_t* txdccaltimeoutdelay, uint8_t* fmtx2pondlydcnt, uint8_t* fmtxtrim, uint8_t* txmixtrim, uint8_t* txtanksel, uint8_t* txfiltcfg, uint8_t* txpacfg)
{
    uint32_t localVal;

    localVal = REG_RPL_RD(RPL_RFTXCONFIG_ADDR);
    *txfiltifen = (localVal & ((uint32_t)0x80000000)) >> 31;
    *txmixedrbiastrim = (localVal & ((uint32_t)0x70000000)) >> 28;
    ...
    *txpacfg = (localVal & ((uint32_t)0x0000000F)) >> 0;
}
...
__INLINE uint8_t rpl_txmix_edrbias_trim_getf(void)
{
    uint32_t localVal;
...
__INLINE void rpl_txmix_edrbias_trim_setf(uint8_t txmixedrbiastrim)
{
    ASSERT_ERR((((uint32_t)txmixedrbiastrim << 28) & ~((uint32_t)0x70000000)) == 0);
    REG_RPL_WR(RPL_RFTXCONFIG_ADDR, (REG_RPL_RD(RPL_RFTXCONFIG_ADDR) & ~((uint32_t)0x70000000)) | ((uint32_t)txmixedrbiastrim << 28));
}
...
{
    ASSERT_ERR((((uint32_t)txpacfg << 0) & ~((uint32_t)0x0000000F)) == 0);
    REG_RPL_WR(RPL_RFTXCONFIG_ADDR, (REG_RPL_RD(RPL_RFTXCONFIG_ADDR) & ~((uint32_t)0x0000000F)) | ((uint32_t)txpacfg << 0));
}
...
__INLINE void rpl_rftxstat_unpack(uint8_t* txdcqval, uint8_t* txdcival, uint8_t* txdccaldead, uint8_t* txdccaldone)
{
    ...
    localVal = REG_RPL_RD(RPL_RFTXSTAT_ADDR);
...
__INLINE void rpl_rftxrxcntl_unpack(uint8_t* txrxctrlforce, uint8_t* vcofcicpcalforce, uint8_t* vcofccalicpmode, uint8_t* rxmdmbypassen, uint8_t* txmdmbypassen, uint8_t* rfpllcaltimeoutdsb, uint8_t* icpcalstart, uint8_t* vcofccalstart, uint8_t* pdon, uint8_t* bbbiason, uint8_t* lodiv2on)
{
    ...
    localVal = REG_RPL_RD(RPL_RFTXRXCNTL_ADDR);
...
#define RPL_RFTXRXCONFIG_RESET  0x2FF14580
...
#define RPL_BB_BIAS_CFG_RST              0x2
...
__INLINE void rpl_rftxrxconfig_unpack(uint8_t* databuspol, uint8_t* icpcaldsb, uint8_t* calibmode, uint8_t* calibtimeoutdelay, uint8_t* icpcalsettletime, uint8_t* vcofccalsettletime, uint8_t* bbbiascfg, uint8_t* dapclkmode, uint8_t* lodiv2trim, uint8_t* lobuftrim)
{
    ...
    localVal = REG_RPL_RD(RPL_RFTXRXCONFIG_ADDR);
...
__INLINE void rpl_rftxrxstat_unpack(uint8_t* caltimeout, uint8_t* icpcaldone, uint8_t* vcofccaldone)
{
    ...
    localVal = REG_RPL_RD(RPL_RFTXRXSTAT_ADDR);
...
__INLINE void rpl_sar_adc_cntl_unpack(uint8_t* saradcforce, uint8_t* saradcsel, uint8_t* saradcmode, uint8_t* saradcstart, uint8_t* saradcon)
{
    ...
    localVal = REG_RPL_RD(RPL_SAR_ADC_CNTL_ADDR);
...
__INLINE void rpl_sar_adc_stat_unpack(uint8_t* saradcdone, uint16_t* saradcval)
{
    ...
    localVal = REG_RPL_RD(RPL_SAR_ADC_STAT_ADDR);
...
__INLINE void rpl_rxadc_satdet_config_unpack(uint8_t* rxadcsatdetmode, uint8_t* rxadcsatdetthr, uint8_t* rxadcsatdetwindow)
{
    ...
    localVal = REG_RPL_RD(RPL_RXADC_SATDET_CONFIG_ADDR);
...
__INLINE void rpl_txdc_detect_config_unpack(uint8_t* txdcmode, uint16_t* txdcrefvalue, uint8_t* txdcsettletime)
{
    ...
    localVal = REG_RPL_RD(RPL_TXDC_DETECT_CONFIG_ADDR);
...
__INLINE void rpl_testmuxcntl_unpack(uint8_t* mux1ctrl, uint8_t* mux0ctrl)
{
    ...
    localVal = REG_RPL_RD(RPL_TESTMUXCNTL_ADDR);
...
__INLINE void rpl_pad_cntl_unpack(uint8_t* drvstrcntl, uint8_t* pulldncntl, uint8_t* pullupcntl)
{
    ...
    localVal = REG_RPL_RD(RPL_PAD_CNTL_ADDR);
 ...
 *   Bits           Field Name   Reset Value
 *  -----   ------------------   -----------
 *     29    LDO_BBPLL_ON_1P2V   1
 *     27   LDO_PLL_BYPASS_1P2V   0
 *     26   LDO_BBPLL_BYPASS_1P2V   0
 *     25        LDO_BB_BYPASS   0
 *     24       LDO_VCO_BYPASS   0
 *     23        LDO_XO_BYPASS   0
 *     22      LDO_RXTX_BYPASS   0
 *  20:16       LDO_BBPLL_TRIM   0x4
 *  13:12       LDO_ADDA_TRIMH   0x0
 *  09:08        LDO_VCO_TRIMH   0x0
 *  05:04        LDO_PLL_TRIMH   0x0
 *  01:00       LDO_RXTX_TRIMH   0x0
 * </pre>
 */
#define RPL_SPARE_CNTL_ADDR   0x0000007C
#define RPL_SPARE_CNTL_OFFSET 0x0000007C
#define RPL_SPARE_CNTL_INDEX  0x0000007C
#define RPL_SPARE_CNTL_RESET  0x20040000
...
// field definitions
#define RPL_LDO_BBPLL_ON_1P2V_BIT        ((uint32_t)0x20000000)
#define RPL_LDO_BBPLL_ON_1P2V_POS        29
#define RPL_LDO_PLL_BYPASS_1P2V_BIT      ((uint32_t)0x08000000)
#define RPL_LDO_PLL_BYPASS_1P2V_POS      27
#define RPL_LDO_BBPLL_BYPASS_1P2V_BIT    ((uint32_t)0x04000000)
#define RPL_LDO_BBPLL_BYPASS_1P2V_POS    26
#define RPL_LDO_BB_BYPASS_BIT            ((uint32_t)0x02000000)
#define RPL_LDO_BB_BYPASS_POS            25
#define RPL_LDO_VCO_BYPASS_BIT           ((uint32_t)0x01000000)
#define RPL_LDO_VCO_BYPASS_POS           24
#define RPL_LDO_XO_BYPASS_BIT            ((uint32_t)0x00800000)
#define RPL_LDO_XO_BYPASS_POS            23
#define RPL_LDO_RXTX_BYPASS_BIT          ((uint32_t)0x00400000)
#define RPL_LDO_RXTX_BYPASS_POS          22
#define RPL_LDO_BBPLL_TRIM_MASK          ((uint32_t)0x001F0000)
#define RPL_LDO_BBPLL_TRIM_LSB           16
#define RPL_LDO_BBPLL_TRIM_WIDTH         ((uint32_t)0x00000005)
#define RPL_LDO_ADDA_TRIMH_MASK          ((uint32_t)0x00003000)
#define RPL_LDO_ADDA_TRIMH_LSB           12
#define RPL_LDO_ADDA_TRIMH_WIDTH         ((uint32_t)0x00000002)
#define RPL_LDO_VCO_TRIMH_MASK           ((uint32_t)0x00000300)
#define RPL_LDO_VCO_TRIMH_LSB            8
#define RPL_LDO_VCO_TRIMH_WIDTH          ((uint32_t)0x00000002)
#define RPL_LDO_PLL_TRIMH_MASK           ((uint32_t)0x00000030)
#define RPL_LDO_PLL_TRIMH_LSB            4
#define RPL_LDO_PLL_TRIMH_WIDTH          ((uint32_t)0x00000002)
#define RPL_LDO_RXTX_TRIMH_MASK          ((uint32_t)0x00000003)
#define RPL_LDO_RXTX_TRIMH_LSB           0
#define RPL_LDO_RXTX_TRIMH_WIDTH         ((uint32_t)0x00000002)

#define RPL_LDO_BBPLL_ON_1P2V_RST        0x1
#define RPL_LDO_PLL_BYPASS_1P2V_RST      0x0
#define RPL_LDO_BBPLL_BYPASS_1P2V_RST    0x0
#define RPL_LDO_BB_BYPASS_RST            0x0
#define RPL_LDO_VCO_BYPASS_RST           0x0
#define RPL_LDO_XO_BYPASS_RST            0x0
#define RPL_LDO_RXTX_BYPASS_RST          0x0
#define RPL_LDO_BBPLL_TRIM_RST           0x4
#define RPL_LDO_ADDA_TRIMH_RST           0x0
#define RPL_LDO_VCO_TRIMH_RST            0x0
#define RPL_LDO_PLL_TRIMH_RST            0x0
#define RPL_LDO_RXTX_TRIMH_RST           0x0

__INLINE void rpl_spare_cntl_pack(uint8_t ldobbpllon1p2v, uint8_t ldopllbypass1p2v, uint8_t ldobbpllbypass1p2v, uint8_t ldobbbypass, uint8_t ldovcobypass, uint8_t ldoxobypass, uint8_t ldorxtxbypass, uint8_t ldobbplltrim, uint8_t ldoaddatrimh, uint8_t ldovcotrimh, uint8_t ldoplltrimh, uint8_t ldorxtxtrimh)
{
    ASSERT_ERR((((uint32_t)ldobbpllon1p2v << 29) & ~((uint32_t)0x20000000)) == 0);
    ASSERT_ERR((((uint32_t)ldopllbypass1p2v << 27) & ~((uint32_t)0x08000000)) == 0);
    ASSERT_ERR((((uint32_t)ldobbpllbypass1p2v << 26) & ~((uint32_t)0x04000000)) == 0);
    ASSERT_ERR((((uint32_t)ldobbbypass << 25) & ~((uint32_t)0x02000000)) == 0);
    ASSERT_ERR((((uint32_t)ldovcobypass << 24) & ~((uint32_t)0x01000000)) == 0);
    ASSERT_ERR((((uint32_t)ldoxobypass << 23) & ~((uint32_t)0x00800000)) == 0);
    ASSERT_ERR((((uint32_t)ldorxtxbypass << 22) & ~((uint32_t)0x00400000)) == 0);
    ASSERT_ERR((((uint32_t)ldobbplltrim << 16) & ~((uint32_t)0x001F0000)) == 0);
    ASSERT_ERR((((uint32_t)ldoaddatrimh << 12) & ~((uint32_t)0x00003000)) == 0);
    ASSERT_ERR((((uint32_t)ldovcotrimh << 8) & ~((uint32_t)0x00000300)) == 0);
    ASSERT_ERR((((uint32_t)ldoplltrimh << 4) & ~((uint32_t)0x00000030)) == 0);
    ASSERT_ERR((((uint32_t)ldorxtxtrimh << 0) & ~((uint32_t)0x00000003)) == 0);
    REG_RPL_WR(RPL_SPARE_CNTL_ADDR,  ((uint32_t)ldobbpllon1p2v << 29) | ((uint32_t)ldopllbypass1p2v << 27) | ((uint32_t)ldobbpllbypass1p2v << 26) | ((uint32_t)ldobbbypass << 25) | ((uint32_t)ldovcobypass << 24) | ((uint32_t)ldoxobypass << 23) | ((uint32_t)ldorxtxbypass << 22) | ((uint32_t)ldobbplltrim << 16) | ((uint32_t)ldoaddatrimh << 12) | ((uint32_t)ldovcotrimh << 8) | ((uint32_t)ldoplltrimh << 4) | ((uint32_t)ldorxtxtrimh << 0));
}

__INLINE void rpl_spare_cntl_unpack(uint8_t* ldobbpllon1p2v, uint8_t* ldopllbypass1p2v, uint8_t* ldobbpllbypass1p2v, uint8_t* ldobbbypass, uint8_t* ldovcobypass, uint8_t* ldoxobypass, uint8_t* ldorxtxbypass, uint8_t* ldobbplltrim, uint8_t* ldoaddatrimh, uint8_t* ldovcotrimh, uint8_t* ldoplltrimh, uint8_t* ldorxtxtrimh)
{
    uint32_t localVal;

    localVal = REG_RPL_RD(RPL_SPARE_CNTL_ADDR);
    *ldobbpllon1p2v = (localVal & ((uint32_t)0x20000000)) >> 29;
    *ldopllbypass1p2v = (localVal & ((uint32_t)0x08000000)) >> 27;
    *ldobbpllbypass1p2v = (localVal & ((uint32_t)0x04000000)) >> 26;
    *ldobbbypass = (localVal & ((uint32_t)0x02000000)) >> 25;
    *ldovcobypass = (localVal & ((uint32_t)0x01000000)) >> 24;
    *ldoxobypass = (localVal & ((uint32_t)0x00800000)) >> 23;
    *ldorxtxbypass = (localVal & ((uint32_t)0x00400000)) >> 22;
    *ldobbplltrim = (localVal & ((uint32_t)0x001F0000)) >> 16;
    *ldoaddatrimh = (localVal & ((uint32_t)0x00003000)) >> 12;
    *ldovcotrimh = (localVal & ((uint32_t)0x00000300)) >> 8;
    *ldoplltrimh = (localVal & ((uint32_t)0x00000030)) >> 4;
    *ldorxtxtrimh = (localVal & ((uint32_t)0x00000003)) >> 0;
}

__INLINE uint8_t rpl_ldo_bbpll_on_1p2v_getf(void)
{
    uint32_t localVal;
...
__INLINE void rpl_ldo_bbpll_on_1p2v_setf(uint8_t ldobbpllon1p2v)
{
    ASSERT_ERR((((uint32_t)ldobbpllon1p2v << 29) & ~((uint32_t)0x20000000)) == 0);
    REG_RPL_WR(RPL_SPARE_CNTL_ADDR, (REG_RPL_RD(RPL_SPARE_CNTL_ADDR) & ~((uint32_t)0x20000000)) | ((uint32_t)ldobbpllon1p2v << 29));
}

__INLINE uint8_t rpl_ldo_pll_bypass_1p2v_getf(void)
{
    uint32_t localVal;
...
__INLINE void rpl_ldo_pll_bypass_1p2v_setf(uint8_t ldopllbypass1p2v)
{
    ASSERT_ERR((((uint32_t)ldopllbypass1p2v << 27) & ~((uint32_t)0x08000000)) == 0);
    REG_RPL_WR(RPL_SPARE_CNTL_ADDR, (REG_RPL_RD(RPL_SPARE_CNTL_ADDR) & ~((uint32_t)0x08000000)) | ((uint32_t)ldopllbypass1p2v << 27));
}

__INLINE uint8_t rpl_ldo_bbpll_bypass_1p2v_getf(void)
{
    uint32_t localVal;
...
__INLINE void rpl_ldo_bbpll_bypass_1p2v_setf(uint8_t ldobbpllbypass1p2v)
{
    ASSERT_ERR((((uint32_t)ldobbpllbypass1p2v << 26) & ~((uint32_t)0x04000000)) == 0);
    REG_RPL_WR(RPL_SPARE_CNTL_ADDR, (REG_RPL_RD(RPL_SPARE_CNTL_ADDR) & ~((uint32_t)0x04000000)) | ((uint32_t)ldobbpllbypass1p2v << 26));
}

__INLINE uint8_t rpl_ldo_bb_bypass_getf(void)
{
    uint32_t localVal;
...
__INLINE void rpl_ldo_bb_bypass_setf(uint8_t ldobbbypass)
{
    ASSERT_ERR((((uint32_t)ldobbbypass << 25) & ~((uint32_t)0x02000000)) == 0);
    REG_RPL_WR(RPL_SPARE_CNTL_ADDR, (REG_RPL_RD(RPL_SPARE_CNTL_ADDR) & ~((uint32_t)0x02000000)) | ((uint32_t)ldobbbypass << 25));
}

__INLINE uint8_t rpl_ldo_vco_bypass_getf(void)
{
    uint32_t localVal;
...
__INLINE void rpl_ldo_vco_bypass_setf(uint8_t ldovcobypass)
{
    ASSERT_ERR((((uint32_t)ldovcobypass << 24) & ~((uint32_t)0x01000000)) == 0);
    REG_RPL_WR(RPL_SPARE_CNTL_ADDR, (REG_RPL_RD(RPL_SPARE_CNTL_ADDR) & ~((uint32_t)0x01000000)) | ((uint32_t)ldovcobypass << 24));
}

__INLINE uint8_t rpl_ldo_xo_bypass_getf(void)
{
    uint32_t localVal;
...
__INLINE void rpl_ldo_xo_bypass_setf(uint8_t ldoxobypass)
{
    ASSERT_ERR((((uint32_t)ldoxobypass << 23) & ~((uint32_t)0x00800000)) == 0);
    REG_RPL_WR(RPL_SPARE_CNTL_ADDR, (REG_RPL_RD(RPL_SPARE_CNTL_ADDR) & ~((uint32_t)0x00800000)) | ((uint32_t)ldoxobypass << 23));
}

__INLINE uint8_t rpl_ldo_rxtx_bypass_getf(void)
{
    uint32_t localVal;
...
__INLINE void rpl_ldo_rxtx_bypass_setf(uint8_t ldorxtxbypass)
{
    ASSERT_ERR((((uint32_t)ldorxtxbypass << 22) & ~((uint32_t)0x00400000)) == 0);
    REG_RPL_WR(RPL_SPARE_CNTL_ADDR, (REG_RPL_RD(RPL_SPARE_CNTL_ADDR) & ~((uint32_t)0x00400000)) | ((uint32_t)ldorxtxbypass << 22));
}

__INLINE uint8_t rpl_ldo_bbpll_trim_getf(void)
{
    uint32_t localVal;
...
__INLINE void rpl_ldo_bbpll_trim_setf(uint8_t ldobbplltrim)
{
    ASSERT_ERR((((uint32_t)ldobbplltrim << 16) & ~((uint32_t)0x001F0000)) == 0);
    REG_RPL_WR(RPL_SPARE_CNTL_ADDR, (REG_RPL_RD(RPL_SPARE_CNTL_ADDR) & ~((uint32_t)0x001F0000)) | ((uint32_t)ldobbplltrim << 16));
}

__INLINE uint8_t rpl_ldo_adda_trimh_getf(void)
{
    uint32_t localVal;
...
__INLINE void rpl_ldo_adda_trimh_setf(uint8_t ldoaddatrimh)
{
    ASSERT_ERR((((uint32_t)ldoaddatrimh << 12) & ~((uint32_t)0x00003000)) == 0);
    REG_RPL_WR(RPL_SPARE_CNTL_ADDR, (REG_RPL_RD(RPL_SPARE_CNTL_ADDR) & ~((uint32_t)0x00003000)) | ((uint32_t)ldoaddatrimh << 12));
}

__INLINE uint8_t rpl_ldo_vco_trimh_getf(void)
{
    uint32_t localVal;
...
__INLINE void rpl_ldo_vco_trimh_setf(uint8_t ldovcotrimh)
{
    ASSERT_ERR((((uint32_t)ldovcotrimh << 8) & ~((uint32_t)0x00000300)) == 0);
    REG_RPL_WR(RPL_SPARE_CNTL_ADDR, (REG_RPL_RD(RPL_SPARE_CNTL_ADDR) & ~((uint32_t)0x00000300)) | ((uint32_t)ldovcotrimh << 8));
}

__INLINE uint8_t rpl_ldo_pll_trimh_getf(void)
{
    uint32_t localVal;
...
__INLINE void rpl_ldo_pll_trimh_setf(uint8_t ldoplltrimh)
{
    ASSERT_ERR((((uint32_t)ldoplltrimh << 4) & ~((uint32_t)0x00000030)) == 0);
    REG_RPL_WR(RPL_SPARE_CNTL_ADDR, (REG_RPL_RD(RPL_SPARE_CNTL_ADDR) & ~((uint32_t)0x00000030)) | ((uint32_t)ldoplltrimh << 4));
}

__INLINE uint8_t rpl_ldo_rxtx_trimh_getf(void)
{
    uint32_t localVal;
...
__INLINE void rpl_ldo_rxtx_trimh_setf(uint8_t ldorxtxtrimh)
{
    ASSERT_ERR((((uint32_t)ldorxtxtrimh << 0) & ~((uint32_t)0x00000003)) == 0);
    REG_RPL_WR(RPL_SPARE_CNTL_ADDR, (REG_RPL_RD(RPL_SPARE_CNTL_ADDR) & ~((uint32_t)0x00000003)) | ((uint32_t)ldorxtxtrimh << 0));
}
...
__INLINE uint32_t rpl_spare_in_getf(void)
{
    ...
    localVal = REG_RPL_RD(RPL_SPARE_STAT_ADDR);
    ASSERT_ERR((localVal & ~((uint32_t)0xFFFFFFFF)) == 0);
    return (localVal >> 0);
}

/**
 * @brief RFRXGAINTABLE7 register definition
 * <pre>
 *   Bits           Field Name   Reset Value
 *  -----   ------------------   -----------
 *  09:08          RXLNA_GAIN7   0x1
 *  06:04          RXMIX_GAIN7   0x0
 *  02:00       RXFILTER_GAIN7   0x3
 * </pre>
 */
#define RPL_RFRXGAINTABLE7_ADDR   0x0000007E
#define RPL_RFRXGAINTABLE7_OFFSET 0x0000007E
#define RPL_RFRXGAINTABLE7_INDEX  0x0000007E
#define RPL_RFRXGAINTABLE7_RESET  0x00000103

__INLINE uint32_t rpl_rfrxgaintable7_get(void)
{
    return REG_RPL_RD(RPL_RFRXGAINTABLE7_ADDR);
}

__INLINE void rpl_rfrxgaintable7_set(uint32_t value)
{
    REG_RPL_WR(RPL_RFRXGAINTABLE7_ADDR, value);
}

// field definitions
#define RPL_RXLNA_GAIN7_MASK      ((uint32_t)0x00000300)
#define RPL_RXLNA_GAIN7_LSB       8
#define RPL_RXLNA_GAIN7_WIDTH     ((uint32_t)0x00000002)
#define RPL_RXMIX_GAIN7_MASK      ((uint32_t)0x00000070)
#define RPL_RXMIX_GAIN7_LSB       4
#define RPL_RXMIX_GAIN7_WIDTH     ((uint32_t)0x00000003)
#define RPL_RXFILTER_GAIN7_MASK   ((uint32_t)0x00000007)
#define RPL_RXFILTER_GAIN7_LSB    0
#define RPL_RXFILTER_GAIN7_WIDTH  ((uint32_t)0x00000003)

#define RPL_RXLNA_GAIN7_RST       0x1
#define RPL_RXMIX_GAIN7_RST       0x0
#define RPL_RXFILTER_GAIN7_RST    0x3

__INLINE void rpl_rfrxgaintable7_pack(uint8_t rxlnagain7, uint8_t rxmixgain7, uint8_t rxfiltergain7)
{
    ASSERT_ERR((((uint32_t)rxlnagain7 << 8) & ~((uint32_t)0x00000300)) == 0);
    ASSERT_ERR((((uint32_t)rxmixgain7 << 4) & ~((uint32_t)0x00000070)) == 0);
    ASSERT_ERR((((uint32_t)rxfiltergain7 << 0) & ~((uint32_t)0x00000007)) == 0);
    REG_RPL_WR(RPL_RFRXGAINTABLE7_ADDR,  ((uint32_t)rxlnagain7 << 8) | ((uint32_t)rxmixgain7 << 4) | ((uint32_t)rxfiltergain7 << 0));
}

__INLINE void rpl_rfrxgaintable7_unpack(uint8_t* rxlnagain7, uint8_t* rxmixgain7, uint8_t* rxfiltergain7)
{
    uint32_t localVal;

    localVal = REG_RPL_RD(RPL_RFRXGAINTABLE7_ADDR);
    *rxlnagain7 = (localVal & ((uint32_t)0x00000300)) >> 8;
    *rxmixgain7 = (localVal & ((uint32_t)0x00000070)) >> 4;
    *rxfiltergain7 = (localVal & ((uint32_t)0x00000007)) >> 0;
}

__INLINE uint8_t rpl_rxlna_gain7_getf(void)
{
    uint32_t localVal;
...
__INLINE void rpl_rxlna_gain7_setf(uint8_t rxlnagain7)
{
    ASSERT_ERR((((uint32_t)rxlnagain7 << 8) & ~((uint32_t)0x00000300)) == 0);
    REG_RPL_WR(RPL_RFRXGAINTABLE7_ADDR, (REG_RPL_RD(RPL_RFRXGAINTABLE7_ADDR) & ~((uint32_t)0x00000300)) | ((uint32_t)rxlnagain7 << 8));
}

__INLINE uint8_t rpl_rxmix_gain7_getf(void)
{
    uint32_t localVal;
...
__INLINE void rpl_rxmix_gain7_setf(uint8_t rxmixgain7)
{
    ASSERT_ERR((((uint32_t)rxmixgain7 << 4) & ~((uint32_t)0x00000070)) == 0);
    REG_RPL_WR(RPL_RFRXGAINTABLE7_ADDR, (REG_RPL_RD(RPL_RFRXGAINTABLE7_ADDR) & ~((uint32_t)0x00000070)) | ((uint32_t)rxmixgain7 << 4));
}

__INLINE uint8_t rpl_rxfilter_gain7_getf(void)
{
    uint32_t localVal;
...
__INLINE void rpl_rxfilter_gain7_setf(uint8_t rxfiltergain7)
{
    ASSERT_ERR((((uint32_t)rxfiltergain7 << 0) & ~((uint32_t)0x00000007)) == 0);
    REG_RPL_WR(RPL_RFRXGAINTABLE7_ADDR, (REG_RPL_RD(RPL_RFRXGAINTABLE7_ADDR) & ~((uint32_t)0x00000007)) | ((uint32_t)rxfiltergain7 << 0));
}

/**
 * @brief RFRXGAINTABLE8 register definition
 * <pre>
 *   Bits           Field Name   Reset Value
 *  -----   ------------------   -----------
 *  09:08          RXLNA_GAIN8   0x0
 *  06:04          RXMIX_GAIN8   0x0
 *  02:00       RXFILTER_GAIN8   0x3
 * </pre>
 */
#define RPL_RFRXGAINTABLE8_ADDR   0x0000007F
#define RPL_RFRXGAINTABLE8_OFFSET 0x0000007F
#define RPL_RFRXGAINTABLE8_INDEX  0x0000007F
#define RPL_RFRXGAINTABLE8_RESET  0x00000003

__INLINE uint32_t rpl_rfrxgaintable8_get(void)
{
    return REG_RPL_RD(RPL_RFRXGAINTABLE8_ADDR);
}

__INLINE void rpl_rfrxgaintable8_set(uint32_t value)
{
    REG_RPL_WR(RPL_RFRXGAINTABLE8_ADDR, value);
}

// field definitions
#define RPL_RXLNA_GAIN8_MASK      ((uint32_t)0x00000300)
#define RPL_RXLNA_GAIN8_LSB       8
#define RPL_RXLNA_GAIN8_WIDTH     ((uint32_t)0x00000002)
#define RPL_RXMIX_GAIN8_MASK      ((uint32_t)0x00000070)
#define RPL_RXMIX_GAIN8_LSB       4
#define RPL_RXMIX_GAIN8_WIDTH     ((uint32_t)0x00000003)
#define RPL_RXFILTER_GAIN8_MASK   ((uint32_t)0x00000007)
#define RPL_RXFILTER_GAIN8_LSB    0
#define RPL_RXFILTER_GAIN8_WIDTH  ((uint32_t)0x00000003)

#define RPL_RXLNA_GAIN8_RST       0x0
#define RPL_RXMIX_GAIN8_RST       0x0
#define RPL_RXFILTER_GAIN8_RST    0x3

__INLINE void rpl_rfrxgaintable8_pack(uint8_t rxlnagain8, uint8_t rxmixgain8, uint8_t rxfiltergain8)
{
    ASSERT_ERR((((uint32_t)rxlnagain8 << 8) & ~((uint32_t)0x00000300)) == 0);
    ASSERT_ERR((((uint32_t)rxmixgain8 << 4) & ~((uint32_t)0x00000070)) == 0);
    ASSERT_ERR((((uint32_t)rxfiltergain8 << 0) & ~((uint32_t)0x00000007)) == 0);
    REG_RPL_WR(RPL_RFRXGAINTABLE8_ADDR,  ((uint32_t)rxlnagain8 << 8) | ((uint32_t)rxmixgain8 << 4) | ((uint32_t)rxfiltergain8 << 0));
}

__INLINE void rpl_rfrxgaintable8_unpack(uint8_t* rxlnagain8, uint8_t* rxmixgain8, uint8_t* rxfiltergain8)
{
    uint32_t localVal;

    localVal = REG_RPL_RD(RPL_RFRXGAINTABLE8_ADDR);
    *rxlnagain8 = (localVal & ((uint32_t)0x00000300)) >> 8;
    *rxmixgain8 = (localVal & ((uint32_t)0x00000070)) >> 4;
    *rxfiltergain8 = (localVal & ((uint32_t)0x00000007)) >> 0;
}

__INLINE uint8_t rpl_rxlna_gain8_getf(void)
{
    uint32_t localVal;
...
__INLINE void rpl_rxlna_gain8_setf(uint8_t rxlnagain8)
{
    ASSERT_ERR((((uint32_t)rxlnagain8 << 8) & ~((uint32_t)0x00000300)) == 0);
    REG_RPL_WR(RPL_RFRXGAINTABLE8_ADDR, (REG_RPL_RD(RPL_RFRXGAINTABLE8_ADDR) & ~((uint32_t)0x00000300)) | ((uint32_t)rxlnagain8 << 8));
}

__INLINE uint8_t rpl_rxmix_gain8_getf(void)
{
    uint32_t localVal;
...
__INLINE void rpl_rxmix_gain8_setf(uint8_t rxmixgain8)
{
    ASSERT_ERR((((uint32_t)rxmixgain8 << 4) & ~((uint32_t)0x00000070)) == 0);
    REG_RPL_WR(RPL_RFRXGAINTABLE8_ADDR, (REG_RPL_RD(RPL_RFRXGAINTABLE8_ADDR) & ~((uint32_t)0x00000070)) | ((uint32_t)rxmixgain8 << 4));
}

__INLINE uint8_t rpl_rxfilter_gain8_getf(void)
{
    uint32_t localVal;
...
__INLINE void rpl_rxfilter_gain8_setf(uint8_t rxfiltergain8)
{
    ASSERT_ERR((((uint32_t)rxfiltergain8 << 0) & ~((uint32_t)0x00000007)) == 0);
    REG_RPL_WR(RPL_RFRXGAINTABLE8_ADDR, (REG_RPL_RD(RPL_RFRXGAINTABLE8_ADDR) & ~((uint32_t)0x00000007)) | ((uint32_t)rxfiltergain8 << 0));
}
